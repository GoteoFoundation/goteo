 ...
 *  CRON SUGGESTED LINE:
 *  5 3 * * *       www-data        /usr/bin/php /..path.../extend/goteo/bin/cli-daily.php --update  > /..path.../var/logs/last-cli-daily.log
 */
...
echo "This script send advises and other mails to donors and creators of calls\n";

ob_start();

// subcontrolador Auto-tips
CallsWatcher::process(true);

// recogemos el buffer para grabar el log
@mkdir(GOTEO_LOG_PATH . 'cron/', 0777, true);
$log_file = GOTEO_LOG_PATH . 'cron/'.date('Ymd').'_callsswatcher.log';
