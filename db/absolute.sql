...
--
-- Servidor: localhost
-- Tiempo de generación: 07-09-2011 a las 19:35:17
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=10 ;
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mensajes de usuarios en proyecto' AUTO_INCREMENT=136 ;
...
INSERT INTO `message` VALUES(135, 'diegobus', 'fixie-per-tothom', NULL, '2011-09-05 16:03:33', 'Espacio taller: Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 1, 0);
...
INSERT INTO `support` VALUES(23, 'fixie-per-tothom', 'Espacio taller', 'Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 'lend', 135);
...
INSERT INTO `user` VALUES('paypal', 'Paypal Tester', NULL, 'paypal_1315159211_per@gmail.com', 'ab4d8d2a5f480a137067da17100271cd176607a1', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2011-09-04 20:02:46', '2011-09-05 01:33:16', 'c8812fc2560e9e5c786a4e2a64db5a15', 1);
...
INSERT INTO `user_personal` VALUES('paypal', NULL, NULL, NULL, NULL, NULL, '', '', '', '');
