...
--
-- Servidor: localhost
-- Tiempo de generación: 30-07-2011 a las 19:45:19
...
INSERT INTO `acl` VALUES(45, '*', '*', '*', '/service/*', 1, '2011-07-13 17:25:24');
INSERT INTO `acl` VALUES(46, '*', 'user', '*', '/preview/*', 1, '2011-07-22 16:43:20');
INSERT INTO `acl` VALUES(47, '*', 'translator', '*', '/translate/*', 1, '2011-07-24 12:46:04');
...
CREATE TABLE `blog` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Blogs de nodo o proyecto' AUTO_INCREMENT=4 ;
...
INSERT INTO `blog` VALUES(2, 'project', 'goteo', 1);
INSERT INTO `blog` VALUES(3, 'project', 'a565092b772c29abc1b92f999af2f2fb', 1);
...
INSERT INTO `comment` VALUES(1, 4, '2011-07-16 13:48:32', 'Comentario', 'goteo');
...
CREATE TABLE `cost` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Desglose de costes de proyectos' AUTO_INCREMENT=171 ;
...
INSERT INTO `cost` VALUES(144, 'a9277be1c7e92eaa36ecae753231bfb1', 'Nueva tarea', '', 'material', 0, 0, '2011-07-11', '2011-07-11');
INSERT INTO `cost` VALUES(151, '5aca87da1aff996c6fb7abaddc947ae0', 'Nueva tarea', NULL, 'task', NULL, 1, '2011-07-17', '2011-07-17');
INSERT INTO `cost` VALUES(152, '75a3d571ea3433f059c9196be05c3c8c', 'Nueva tarea', '', 'task', 0, 1, '2011-07-18', '2011-07-18');
INSERT INTO `cost` VALUES(153, '75a3d571ea3433f059c9196be05c3c8c', 'Otra tarea', '', 'task', 0, 1, '2011-07-22', '2011-08-06');
INSERT INTO `cost` VALUES(162, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nueva tarea', '', 'task', 0, 1, '2011-07-06', '2011-07-16');
INSERT INTO `cost` VALUES(166, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nueva tarea', NULL, 'task', NULL, 1, NULL, NULL);
INSERT INTO `cost` VALUES(167, 'goteo', 'Nueva tarea', '', 'task', 0, 1, '2011-07-14', '2011-07-30');
INSERT INTO `cost` VALUES(168, '891e70c92139708c0b1609b99d3f8c33', 'Nueva tarea', NULL, 'task', NULL, 1, NULL, NULL);
INSERT INTO `cost` VALUES(169, '891e70c92139708c0b1609b99d3f8c33', 'Nueva tarea', 'Nueva tarea', 'task', 0, 0, '0000-00-00', '0000-00-00');
INSERT INTO `cost` VALUES(170, 'c099453acc7c32d6d3c99ff8a7caa132', 'Nueva tarea', 'Nueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNueva tareaNu', 'material', 0, 0, '0000-00-00', '0000-00-00');
...
INSERT INTO `icon` VALUES('code', 'CÃ³digo fuente', 'CÃ³digo fuente', 'social', 0);
INSERT INTO `icon` VALUES('design', 'DiseÃ±o', 'DiseÃ±o', 'social', 0);
INSERT INTO `icon` VALUES('file', 'Archivos digitales', 'Archivos digitales', NULL, 0);
INSERT INTO `icon` VALUES('manual', 'Manuales', 'Manuales', 'social', 0);
INSERT INTO `icon` VALUES('money', 'Dinero', 'Dinero', 'individual', 50);
INSERT INTO `icon` VALUES('other', 'Otro', 'Otro', NULL, 99);
INSERT INTO `icon` VALUES('product', 'Producto', 'Producto', 'individual', 0);
INSERT INTO `icon` VALUES('service', 'Servicios', 'Con servicio nos referimos a...', NULL, 0);
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=168 ;

--
-- Volcar la base de datos para la tabla `invest`
--

INSERT INTO `invest` VALUES(1, 'esenabre', 'hkp', 'albabenitez1983@gmail.com', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
...
INSERT INTO `invest` VALUES(3, 'esenabre', 'oh-oh-fase-2', 'ahernandez@lossantos.org', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(4, 'esenabre', 'goteo', 'ahernandez@lossantos.org', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(5, 'esenabre', 'archinhand-architecture-in-your-hand', 'programaskreativos@gmail.com', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
...
INSERT INTO `invest` VALUES(10, 'goteo', 'nodo-movil', 'geopetro10@yahoo.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(11, 'goteo', 'goteo', 'anto@filosomatika.net', 10, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(12, 'goteo', 'nodo-movil', 'chonmube@gmail.com', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(13, 'goteo', 'goteo', 'chonmube@gmail.com', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(14, 'goteo', 'nodo-movil', 'crdelcorral@hotmail.com', 10, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(15, 'goteo', 'hkp', 'carlos@carloscriado.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(16, 'goteo', 'goteo', 'carlos@carloscriado.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(17, 'goteo', 'hkp', 'innovacion@energiaextremadura.org', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(18, 'goteo', 'goteo', 'innovacion@energiaextremadura.org', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(19, 'goteo', 'archinhand-architecture-in-your-hand', 'ibellosobueso@yahoo.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(20, 'goteo', 'hkp', 'ibellosobueso@yahoo.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(21, 'goteo', 'hkp', ' lernestomc@Yahoo.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(22, 'goteo', 'goteo', ' lernestomc@Yahoo.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(23, 'goteo', 'nodo-movil', 'marcela.palma@fundacionciudadania.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(24, 'goteo', 'goteo', 'marcela.palma@fundacionciudadania.es', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(25, 'goteo', 'goteo', 'sara.tena@aupex.org', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(26, 'goteo', 'oh-oh-fase-2', 'vstabares@gmail.com', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(27, 'goteo', 'nodo-movil', 'vstabares@gmail.com', 5, 1, NULL, 1, '2011-07-07', '2011-07-07', NULL, NULL, NULL, NULL, 'cash', 'root', 1);
INSERT INTO `invest` VALUES(28, 'goteo', 'todojunto-letterpress', 'raul.casadogonzalez@gmail.com', 5, 1, 0, 1, '2011-07-07', '2011-07-07', NULL, '', '', '', 'cash', 'root', 0);
INSERT INTO `invest` VALUES(29, 'goteo', 'oh-oh-fase-2', 'raul.casadogonzalez@gmail.com', 5, 1, 0, 1, '2011-07-07', '2011-07-07', NULL, '', '', '', 'cash', 'root', 0);
...
INSERT INTO `invest` VALUES(162, 'goteo', 'pliegos', 'goteo@doukeshi.org', 10, 0, NULL, NULL, '2011-07-20', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(163, 'goteo', 'pliegos', 'goteo@doukeshi.org', 10, 0, NULL, NULL, '2011-07-20', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(164, 'goteo', 'pliegos', 'goteo@doukeshi.org', 10, 0, NULL, NULL, '2011-07-20', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(165, 'goteo', 'pliegos', 'goteo@doukeshi.org', 1000, 0, 1, 1, '2011-07-20', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(166, 'root', 'nodo-movil', 'julian_1302552287_per@gmail.com', 10, 0, NULL, NULL, '2011-07-20', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(167, 'root', 'pliegos', 'julian_1302552287_per@gmail.com', 10, 0, NULL, NULL, '2011-07-20', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
...
INSERT INTO `invest_address` VALUES(162, 'goteo', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃ±a');
INSERT INTO `invest_address` VALUES(163, 'goteo', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃ±a');
INSERT INTO `invest_address` VALUES(164, 'goteo', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃ±a');
INSERT INTO `invest_address` VALUES(165, 'goteo', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃ±a');
INSERT INTO `invest_address` VALUES(166, 'root', '', '', '', 'EspaÃ±a');
INSERT INTO `invest_address` VALUES(167, 'root', '', '', '', 'EspaÃ±a');
...
INSERT INTO `invest_reward` VALUES(163, 95, 0);
INSERT INTO `invest_reward` VALUES(167, 95, 0);
INSERT INTO `invest_reward` VALUES(167, 118, 0);
...
INSERT INTO `license` VALUES('agpl', 'Affero General Public License', 'GNU Affero General Public License', '', '', 1);
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mensajes de usuarios en proyecto' AUTO_INCREMENT=20 ;
...
INSERT INTO `message` VALUES(6, 'goteo', 'a565092b772c29abc1b92f999af2f2fb', NULL, '2011-07-15 03:13:56', 'd fasdf asdf asdf asdf as: d fasdf asdf asdf asdf asdf', 1, 0);
INSERT INTO `message` VALUES(8, 'ebaraonap', 'archinhand-architecture-in-your-hand', NULL, '2011-07-19 00:24:09', 'Testers de la herramienta: Estudiantes de arquitectura', 1, 0);
INSERT INTO `message` VALUES(9, 'geraldo', 'canal-alfa', NULL, '2011-07-19 00:24:12', 'ProgramaciÃ³n extractor: ProgramaciÃ³n herramientas para la extraciÃ³n de videos', 1, 0);
INSERT INTO `message` VALUES(10, 'geraldo', 'canal-alfa', NULL, '2011-07-19 00:24:12', 'InvestigaciÃ³n: InvestigaciÃ³n de algoritmos para el reconocimiento automatizado del contenido de vÃ­deos', 1, 0);
INSERT INTO `message` VALUES(11, 'geraldo', 'canal-alfa', NULL, '2011-07-19 00:24:12', 'ProgramaciÃ³n editor: ProgramaciÃ³n editor de vÃ­deo online', 1, 0);
INSERT INTO `message` VALUES(12, 'goteo', 'goteo', NULL, '2011-07-19 00:24:15', 'Nueva colaboraciÃ³n: ', 1, 0);
INSERT INTO `message` VALUES(13, 'itxaso', 'mi-barrio', NULL, '2011-07-19 00:24:25', 'DiseÃ±adores: DiseÃ±adores web, espertos en redes sociales', 1, 0);
INSERT INTO `message` VALUES(14, 'itxaso', 'mi-barrio', NULL, '2011-07-19 00:24:25', 'Aulas para talleres: Aulas para talleres', 1, 0);
INSERT INTO `message` VALUES(15, 'goteo', '43b8c28144ad2a9687374e95ae9ac4d6', NULL, '2011-07-19 00:24:34', 'Nueva colaboraciÃ³n: g dfg dfg dg ', 1, 0);
INSERT INTO `message` VALUES(16, 'goteo', 'a9277be1c7e92eaa36ecae753231bfb1', NULL, '2011-07-19 00:24:40', 'Nueva colaboraciÃ³n: ', 1, 0);
INSERT INTO `message` VALUES(17, 'goteo', '5aca87da1aff996c6fb7abaddc947ae0', NULL, '2011-07-19 00:25:30', 'Nueva colaboraciÃ³n: ', 1, 0);
INSERT INTO `message` VALUES(18, 'goteo', 'c099453acc7c32d6d3c99ff8a7caa132', NULL, '2011-07-22 22:51:31', 'Nueva colaboraciÃ³n: ', 1, 0);
INSERT INTO `message` VALUES(19, 'betatester', 'pliegos', 2, '2011-07-25 18:31:07', 'Tengo recargables', 0, 0);
...
INSERT INTO `news_lang` VALUES(2, 'ca', 'CAT', 'CAT', NULL);
INSERT INTO `news_lang` VALUES(2, 'en', 'ENG', 'ENG', NULL);
...
INSERT INTO `page` VALUES('campaign', 'Servicio CampaÃ±as', 'DescripciÃ³n de servicio de campaÃ±as', '/service/campaign');
INSERT INTO `page` VALUES('community', 'Comunidad Goteo', 'Contenido seccion comunidad', '/community');
INSERT INTO `page` VALUES('consulting', 'Servicio ConsultorÃ­a', 'DescripciÃ³n de servicio de consultorÃ­a', '/service/consulting');
...
INSERT INTO `page` VALUES('workshop', 'Servicio Talleres', 'DescripciÃ³n de servicio de talleres', '/service/workshop');
...
CREATE TABLE `post` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Entradas para la portada' AUTO_INCREMENT=18 ;

--
-- Volcar la base de datos para la tabla `post`
--

INSERT INTO `post` VALUES(1, 1, 'Â¿Porque goteo es diferente?', 'Aqui el video que explica los diferenciales con las otras plataformas. Goteo se distingue principalmente de otras plataformas por su apuesta diferencial y focalizada en proyectos de cÃ³digo abierto1, que comparten conocimiento, procesos, resultado, responsabilidad y benÃ©fico, desde la filosofÃ­a del procomÃºn. Goteo pone el acento en la misiÃ³n pÃºblica, apoyando proyectos que favorezcan el empoderamiento colectivo y el bien comÃºn.', 'http://vimeo.com/20597320', 97, '2011-06-01', 1, 0, 1, 0, 0);
INSERT INTO `post` VALUES(2, 1, 'asdasdf', 'asdf asdf asd', NULL, NULL, '0000-00-00', 1, 1, NULL, 1, 0);
INSERT INTO `post` VALUES(3, 1, 'Goteo, taller de crowdfunding, sigue rodando', 'Goteo. Monedas de 5 gotas\r\nEl taller "Goteo, cultura de la financiaciÃ³n colectiva (crowdfunding)" sigue rodando.\r\nEl taller Goteo ofrece informaciÃ³n teÃ³rica sobre las diferentes tipologÃ­as de financiaciÃ³n colectiva, acercando de forma dinÃ¡mica y atractiva al crowdfunding como estrategia de interÃ©s tanto para la financiaciÃ³n como para la difusiÃ³n y generaciÃ³n de comunidad.\r\n\r\nPrÃ³xima parada: 24 de junio en CÃ¡ceres en el Centro de Conocimiento AldealabC3, edificio Embarcadero.\r\nCÃ³mo apuntarse: (plazas limitadas)\r\n609 519 493 (coordinadora Chon MuÃ±oz)\r\n\r\nOrganiza:\r\nProyecto FÃ©nix. FactorÃ­a de la InnovaciÃ³n/ Ayuntamiento de CÃ¡ceres / ConcejalÃ­a de InnovaciÃ³n, Fomento y Desarrollo\r\nTecnolÃ³gico.\r\n\r\nCon la colaboraciÃ³n del Gabinete del Iniciativa Joven de Extremadura.\r\n\r\nEl crowdfunding ha surgido muy recientemente en EspaÃ±a y en pocos meses ha demostrado ser una eficaz alternativa de financiaciÃ³n de proyectos. Pero al mismo tiempo tiene efectos secundarios altamente interesantes para el Ã¡mbito cultural/social y de TICs, como la generaciÃ³n de comunidades de interÃ©s y la capacidad de generar expectativas de forma previa a la presentaciÃ³n final del proyecto.\r\n\r\nLa duraciÃ³n del taller es de cuatro horas, que se distribuyen en dos partes:\r\n\r\na) exposiciÃ³n del intensivo estudio realizado por Platoniq sobre diferentes tipologÃ­as de plataformas, diferenciando\r\nmicrofinanciaciÃ³n, financiaciÃ³n colectiva (crowdfunding) y prÃ©stamos p2p.\r\n\r\nb) parte prÃ¡ctica en la que se experimenta la financiaciÃ³n colectiva de una serie de proyectos reales. Esta parte prÃ¡ctica escenifica en modo "analÃ³gico" cÃ³mo funciona una plataforma de crowdfunding a travÃ©s de dinÃ¡micas participativas.\r\n\r\nGracias a ellas es posible comprobar aspectos clave como pueden ser criterios de evaluaciÃ³n o cÃ³mo hacer atractivos proyectos. Para ello se han elaborado herramientas como barÃ³metros de valoraciÃ³n de proyectos a partir de indicadores como el grado de innovaciÃ³n, nivel de proximidad, coherencia, etc., con los que interactuarÃ¡n los participantes.\r\n\r\n-> MÃ¡s sobre el taller:\r\n\r\nhttp://youcoop.org/es/goteo/p/5/goteo-workshop-cultura-de-la-microfinanciacion/\r\n\r\n-> MÃ¡s sobre la cultura del crowdfunding en nuestro colaboratorio:\r\nYOUCOOP.ORG\r\n\r\nhttp://www.youcoop.org/goteo\r\n\r\n-> MÃ¡s sobre contextos en los que ya se ha realizado el taller:\r\n\r\n1) CCCB. Barcelona:\r\n\r\nhttp://www.cccb.org/es/curs_o_conferencia-i_c_i_econom_a_distribuida-33719\r\n\r\nhttp://www.flickr.com/photos/cccb/sets/72157625471082121/\r\n\r\n2) MATADERO. Madrid:\r\n\r\nhttp://www.mataderomadrid.org/ficha/768/goteo-cultura-de-la-financiacion-colectiva.html\r\n\r\n3) DIA DE LA PERSONA EMPRENDEDORA. BILBAO:\r\n\r\nhttp://eutokia.org/2011/05/taller-goteo-platoniq-x-edicion-dia-de-la-persona-emprendedora-2011-05-05/\r\n\r\n4) ESCUELA DE VERANO DE LA RED DE TEATROS. ALMAGRO:\r\n\r\nhttp://www.redescueladeverano.es/2011/programa_de_cursos/ficha.php?id=55', '', 0, '2011-06-27', 1, 0, 1, 1, 1);
INSERT INTO `post` VALUES(4, 1, 'df g sdfg sdfg sdfg ', NULL, NULL, NULL, '0000-00-00', 2, 1, 1, NULL, 0);
INSERT INTO `post` VALUES(5, 3, 'Prueba de actualizaciond esde dashboard', 'Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard Prueba de actualizaciond esde dashboard ', '', 98, '2011-07-15', 1, 0, NULL, NULL, 1);
INSERT INTO `post` VALUES(7, 3, 'sdaf asdf asdf asdf', 'sdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdf', '', 0, '2011-07-15', 1, 0, NULL, NULL, 1);
INSERT INTO `post` VALUES(8, 3, 'sdaf asdf asdf asdf', 'sdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdfsdaf asdf asdf asdf', '', 0, '2011-07-15', 1, 0, NULL, NULL, 1);
INSERT INTO `post` VALUES(9, 1, 'AÃ±adiendo nueva entrada para el pie', 'AÃ±adiendo nueva entrada para el pie', '', 0, '0000-00-00', 1, 0, 0, 1, 0);
INSERT INTO `post` VALUES(10, 2, 'Nueva actualizaciÃ³n', 'Nueva actualizaciÃ³n Nueva actualizaciÃ³n Nueva actualizaciÃ³n', '', 0, '2011-07-16', 1, 1, NULL, NULL, 0);
INSERT INTO `post` VALUES(11, 2, 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', '', 0, '2011-07-19', 1, 1, NULL, NULL, 0);
INSERT INTO `post` VALUES(12, 2, 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', '', 0, '2011-07-19', 1, 1, NULL, NULL, 0);
INSERT INTO `post` VALUES(13, 2, 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', '', 0, '2011-07-19', 1, 1, NULL, NULL, 0);
INSERT INTO `post` VALUES(14, 2, 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', '', 0, '2011-07-19', 1, 1, NULL, NULL, 0);
INSERT INTO `post` VALUES(15, 2, 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', '', 0, '2011-07-19', 1, 1, NULL, NULL, 0);
INSERT INTO `post` VALUES(17, 2, 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', 'Aliquam auctor nisi eget arcu laoreet blandit.  Aliquam auctor nisi eget arcu laoreet blandit.', '', 0, '2011-07-19', 1, 0, NULL, NULL, 1);
...
INSERT INTO `post_lang` VALUES(1, 'ca', 'CAT', 'CAT');
...
INSERT INTO `project_category` VALUES('goteo', 5);
INSERT INTO `project_category` VALUES('goteo', 6);
INSERT INTO `project_category` VALUES('goteo', 13);
...
INSERT INTO `project_image` VALUES('5aca87da1aff996c6fb7abaddc947ae0', 77);
INSERT INTO `project_image` VALUES('5aca87da1aff996c6fb7abaddc947ae0', 78);
INSERT INTO `project_image` VALUES('5aca87da1aff996c6fb7abaddc947ae0', 79);
INSERT INTO `project_image` VALUES('5aca87da1aff996c6fb7abaddc947ae0', 102);
INSERT INTO `project_image` VALUES('5aca87da1aff996c6fb7abaddc947ae0', 104);
INSERT INTO `project_image` VALUES('5aca87da1aff996c6fb7abaddc947ae0', 106);
...
CREATE TABLE `promote` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Proyectos destacados' AUTO_INCREMENT=7 ;

--
-- Volcar la base de datos para la tabla `promote`
--

INSERT INTO `promote` VALUES(2, 'goteo', 'nodo-movil', 'Nodomovil', 'Tiwene muchos cofinanciadores', 3);
INSERT INTO `promote` VALUES(3, 'goteo', 'pliegos', 'Pliegos', 'Repliegandose', 2);
INSERT INTO `promote` VALUES(6, 'goteo', 'archinhand-architecture-in-your-hand', 'asdf asdf', 'as dfasdf ', 1);
...
INSERT INTO `promote_lang` VALUES(2, 'es', 'Nodomovui', 'sdaf asd ');
...
INSERT INTO `purpose` VALUES('error-register-pasword-empty', 'Texto error-register-pasword-empty', NULL, 'register');
...
INSERT INTO `purpose` VALUES('footer-header-categories', 'CategorÃ­as', NULL, 'footer');
INSERT INTO `purpose` VALUES('footer-header-follow_us', 'SÃ­ganos', NULL, 'footer');
...
INSERT INTO `purpose` VALUES('footer-header-social', 'SÃ­ganos', NULL, 'footer');
...
INSERT INTO `purpose` VALUES('footer-service-campaign', 'CampaÃ±as', NULL, 'footer');
INSERT INTO `purpose` VALUES('footer-service-consulting', 'ConsultorÃ­a', NULL, 'footer');
...
INSERT INTO `purpose` VALUES('image', 'Texto image', NULL, 'general');
...
INSERT INTO `purpose` VALUES('mandatory-cost-field-description', 'Es obligatorio poner una descripciÃ³n al coste', NULL, 'costs');
...
INSERT INTO `purpose` VALUES('mandatory-project-individual_rewards', 'Texto mandatory-project-individual_rewards', NULL, 'general');
...
INSERT INTO `purpose` VALUES('mandatory-project-social_rewards', 'Texto mandatory-project-social_rewards', NULL, 'general');
INSERT INTO `purpose` VALUES('mandatory-project-total-costs', 'Es obligatorio especificar algÃºn coste', NULL, 'costs');
INSERT INTO `purpose` VALUES('mandatory-register-field-email', 'Texto mandatory-register-field-email', NULL, 'register');
...
INSERT INTO `purpose` VALUES('overview-field-description_group', 'Texto overview-field-description_group', NULL, 'general');
INSERT INTO `purpose` VALUES('overview-field-goal', 'Objetivos', NULL, 'overview');
INSERT INTO `purpose` VALUES('overview-field-image_gallery', 'ImÃ¡genes actuales', NULL, 'overview');
...
INSERT INTO `purpose` VALUES('overview-fields-images-title', 'ImÃ¡genes del proyecto', NULL, 'overview');
...
INSERT INTO `purpose` VALUES('regular-footer-legal', 'TÃ©rminos legales', NULL, 'footer');
...
INSERT INTO `purpose` VALUES('tooltip-project-description_group', 'Texto tooltip-project-description_group', NULL, 'general');
...
INSERT INTO `purpose` VALUES('user-account-inactive', 'La cuenta esta desactivada', NULL, 'register');
INSERT INTO `purpose` VALUES('user-activate-already-active', 'La cuenta de usuario ya esta activada', NULL, 'register');
INSERT INTO `purpose` VALUES('user-activate-fail', 'Texto user-activate-fail', NULL, 'register');
...
INSERT INTO `purpose` VALUES('validate-project-costs-any_error', 'Hay algÃºn error en el desglose de costes', NULL, 'costs');
...
INSERT INTO `purpose` VALUES('validate-project-individual_rewards-any_error', 'Hay algÃºn error en las recompensas individuales', NULL, 'rewards');
INSERT INTO `purpose` VALUES('validate-project-social_rewards', 'Hay que poner algÃºn retorno', NULL, 'rewards');
INSERT INTO `purpose` VALUES('validate-project-social_rewards-any_error', 'Hay algÃºn error en los retornos colectivos', NULL, 'rewards');
...
INSERT INTO `purpose` VALUES('validate-project-userProfile-any_error', 'Hay algÃºn error en las webs', NULL, 'profile');
...
CREATE TABLE `reward` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Retornos colectivos e individuales' AUTO_INCREMENT=193 ;
...
INSERT INTO `reward` VALUES(139, 'goteo', 'Prueba OH', 'sd fasdf ', 'social', 'file', NULL, 'fal', 0, 0, 0);
INSERT INTO `reward` VALUES(140, 'goteo', 'Prueba Otro', 'Solo otro retorno', 'social', 'code', 'Chipiflaustico', 'tapr', 0, 0, 0);
...
INSERT INTO `reward` VALUES(164, 'a9277be1c7e92eaa36ecae753231bfb1', 'Nueva recompensa individual', 'asdfsf', 'individual', 'other', 'Solo otro tipo de recompensa', NULL, 0, 0, 0);
INSERT INTO `reward` VALUES(165, 'goteo', 'De puta madre', 'La recompensa', 'individual', 'product', 'Esto es', NULL, 10, 0, 0);
INSERT INTO `reward` VALUES(169, 'a9277be1c7e92eaa36ecae753231bfb1', 'Nuevo retorno colectivo', '', 'social', 'file', NULL, 'fal', NULL, NULL, 0);
INSERT INTO `reward` VALUES(170, 'a9277be1c7e92eaa36ecae753231bfb1', 'Codigofuente', 'sdf asdf asdf asdf ', 'social', 'code', NULL, 'bsd', NULL, NULL, 0);
INSERT INTO `reward` VALUES(176, 'a9277be1c7e92eaa36ecae753231bfb1', 'Nuevo retorno colectivo', '', 'social', 'design', NULL, 'cc0', NULL, NULL, 0);
INSERT INTO `reward` VALUES(177, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nuevo retorno colectivo', '', 'social', 'file', NULL, NULL, NULL, NULL, 0);
INSERT INTO `reward` VALUES(178, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nueva recompensa individual', '', 'individual', 'file', NULL, NULL, 0, 0, 0);
INSERT INTO `reward` VALUES(184, '5aca87da1aff996c6fb7abaddc947ae0', 'Nuevo retorno colectivo', NULL, 'social', '', NULL, '', NULL, NULL, 0);
INSERT INTO `reward` VALUES(185, '5aca87da1aff996c6fb7abaddc947ae0', 'Nueva recompensa individual', '', 'individual', 'product', NULL, NULL, 0, 12, 0);
INSERT INTO `reward` VALUES(186, '75a3d571ea3433f059c9196be05c3c8c', 'Nuevo retorno colectivo', '', 'social', 'service', NULL, '', NULL, NULL, 0);
INSERT INTO `reward` VALUES(187, '75a3d571ea3433f059c9196be05c3c8c', 'Nueva recompensa individual', '', 'individual', 'file', NULL, NULL, 12, 2, 0);
INSERT INTO `reward` VALUES(188, 'a9277be1c7e92eaa36ecae753231bfb1', 'Nuevo retorno colectivo', '', 'social', 'code', '', NULL, NULL, NULL, 0);
INSERT INTO `reward` VALUES(189, 'c099453acc7c32d6d3c99ff8a7caa132', 'Nuevo retorno colectivo', 'Nuevo retorno colectivo Nuevo retorno colectivo Nuevo retorno colectivo', 'social', NULL, NULL, NULL, NULL, NULL, 0);
INSERT INTO `reward` VALUES(190, 'c099453acc7c32d6d3c99ff8a7caa132', 'Nueva recompensa individual', NULL, 'individual', '', NULL, NULL, 0, 0, 0);
INSERT INTO `reward` VALUES(191, 'c099453acc7c32d6d3c99ff8a7caa132', 'Nueva recompensa individual', NULL, 'individual', '', NULL, NULL, 0, 0, 0);
INSERT INTO `reward` VALUES(192, 'c099453acc7c32d6d3c99ff8a7caa132', 'Nueva recompensa individual', '', 'individual', 'product', NULL, NULL, 0, 0, 0);
...
INSERT INTO `sponsor` VALUES(1, 'CCCB', 'http://www.cccb.org/lab', 92, 2);
INSERT INTO `sponsor` VALUES(2, 'CONCA', 'http://www.conca.cat/', 91, 1);
INSERT INTO `sponsor` VALUES(3, 'ICUB', 'http://barcelonacultura.bcn.cat/', 93, 3);
...
CREATE TABLE `support` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Colaboraciones' AUTO_INCREMENT=82 ;
...
INSERT INTO `support` VALUES(59, 'archinhand-architecture-in-your-hand', 'Testers de la herramienta', 'Estudiantes de arquitectura', 'task', 8);
INSERT INTO `support` VALUES(60, 'mi-barrio', 'DiseÃ±adores', 'DiseÃ±adores web, espertos en redes sociales', 'task', 13);
INSERT INTO `support` VALUES(61, 'mi-barrio', 'Aulas para talleres', 'Aulas para talleres', 'lend', 14);
...
INSERT INTO `support` VALUES(68, 'canal-alfa', 'ProgramaciÃ³n extractor', 'ProgramaciÃ³n herramientas para la extraciÃ³n de videos', 'task', 9);
INSERT INTO `support` VALUES(69, 'canal-alfa', 'InvestigaciÃ³n', 'InvestigaciÃ³n de algoritmos para el reconocimiento automatizado del contenido de vÃ­deos', 'task', 10);
INSERT INTO `support` VALUES(70, 'canal-alfa', 'ProgramaciÃ³n editor', 'ProgramaciÃ³n editor de vÃ­deo online', 'task', 11);
INSERT INTO `support` VALUES(71, 'robocicla', 'Traductor', 'Traductor@ (ingles / portugues / italiano / frances / griego)', 'task', 80);
INSERT INTO `support` VALUES(72, 'a9277be1c7e92eaa36ecae753231bfb1', 'Nueva colaboraciÃ³n', '', 'task', 16);
INSERT INTO `support` VALUES(73, 'goteo', 'Nueva colaboraciÃ³n', '', 'task', 12);
INSERT INTO `support` VALUES(74, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nueva colaboraciÃ³n', 'g dfg dfg dg ', 'task', 15);
INSERT INTO `support` VALUES(75, '5aca87da1aff996c6fb7abaddc947ae0', 'Nueva colaboraciÃ³n', '', 'task', 17);
INSERT INTO `support` VALUES(76, '75a3d571ea3433f059c9196be05c3c8c', 'Nueva colaboraciÃ³n', '', 'task', NULL);
INSERT INTO `support` VALUES(78, '8851739335520c5eeea01cd745d0442d', 'Nueva colaboraciÃ³n', '', 'task', NULL);
INSERT INTO `support` VALUES(79, '8851739335520c5eeea01cd745d0442d', 'Nueva colaboraciÃ³n', '', 'task', NULL);
INSERT INTO `support` VALUES(80, 'c099453acc7c32d6d3c99ff8a7caa132', 'Nueva colaboraciÃ³n', '', 'task', 18);
INSERT INTO `support` VALUES(81, 'c099453acc7c32d6d3c99ff8a7caa132', 'Nueva colaboraciÃ³n', '', 'task', NULL);
...
INSERT INTO `text` VALUES('discover-banner-header', 'es', 'Por categoria, lugar o retorno,<br /><span class="red">encuentra el proyecto</span> con el que mÃ¡s te identificas');
...
INSERT INTO `text` VALUES('open-banner-header', 'es', '<div class="modpo-open">OPEN</div><div class="modpo-percent">100% ABIERTO</div><div class="modpo-whyopen">Â¿Por quÃ© abierto?</div>');
...
INSERT INTO `text` VALUES('translate-home-guide', 'ca', 'Missatge portada panell traducciÃ³');
INSERT INTO `text` VALUES('translate-home-guide', 'es', 'Prueba traducir al espaÃ±ol. Mensaje portada panel traductor');
...
INSERT INTO `user` VALUES('aballesteros', 'AndrÃ©s Ballesteros', 'CÃ¡ceres', 'geopetro10@yahoo.es', '975b5f25e95d2afd7c22b50342ddffc5edba89a1', 'Abvmedioambiente', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:15', '');
INSERT INTO `user` VALUES('abenitez', 'Alba Benitez', 'CÃ¡ceres', 'albabenitez1983@gmail.com', 'ccb39ea899a2dbc60867cfec2495ffcbfb2eb42d', 'AutÃ³noma-Sector cultural', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('aceballos', 'Ana Ceballos', 'Madrid', 'veyota79@hotmail.com', 'db5c3952834c9f1a64f4086e94afa40013dd3a5b', 'Gestor Cultural', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('afernandez', 'Ana Fdez Osorio', 'Barcelona', 'ana@dispuesta.net', 'bc4b56d5b2fb0ddb27e4ba97ed8483c2b96b9b43', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('afolguera', 'Antonia Folguera', 'Barcelona', 'antonia@riereta.net', '232083fdb8d80ac58b79ab55b75d302e54b5038b', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('ahernandez', 'Alejandro HernÃ¡ndez Renner', 'CÃ¡ceres', 'ahernandez@lossantos.org', '79dd1d71cb13c723ac077e636c47d14720498b4c', 'Director FundaciÃ³n Maimona', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('amartinez', 'Alfonso MartÃ­nez', 'Barcelona', 'martinezrubioo@gmail.com', 'b9ee4c65c2de3f007eef8e0cd9e39d2ef49aa17b', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('amorales', 'Ana Morales', 'Madrid', 'moralespartida@gmail.com', 'e8396d7fc730a83111aa251a80d44e4295d15d85', 'Trabajo en temas culturales', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('amunoz', 'AscensiÃ³n MuÃ±oz BenÃ­tez', 'CÃ¡ceres', 'chonmube@gmail.com', '18542a1914f496a4c66739483a45620edfc40a65', 'AutÃ³noma-Gestora cultural', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-07-05 01:54:33', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('aollero', 'Ana  Ollero', 'CÃ¡ceres', 'programaskreativos@gmail.com', 'a1d29ffc56898468565d89a267fa13b40d396278', 'Programas creativos', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('aramos', 'Avelino Ramos Casado', 'CÃ¡ceres', 'crdelcorral@hotmail.com', '54a53a49e8c51e869cdc0f8f5513d48ec8e3e149', 'Sertumon', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('arecio', 'Anto Recio', 'CÃ¡ceres', 'anto@filosomatika.net', '31d6347ed7f1809654680fb6f1bb5bed2ab07408', 'Fundecyt', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:51', '');
INSERT INTO `user` VALUES('asanz', 'Ana SÃ¡nz Grados', 'CÃ¡ceres', 'asanzgr@hotmail.com', 'a32009cc0d01b5a96aced6cff6cf4be61e8fbd7c', 'AsociaciÃ³n de Mujeres Malvaluna', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('avigara', 'Ana Vigara', 'Madrid', 'ana.vigara@iniciativajoven.org', 'b093c07f7a1c81bb216456e7cceb0520a632437f', 'TÃ©cnico de proyectos', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 20:48:57', '');
INSERT INTO `user` VALUES('betatester', 'Jose', 'aqui , no lo ves?', 'pepe_1303727124_per@gmail.com', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 'Poca cosa hay que contar', 'keyword1, keyword2, keyword3, keyword4, keyword5, keyword6', 1, 72, 'Ideas geniales!', 'twitter', 'user_facebook', 'identica', '', 'linkedin', 0, '2011-07-04 16:45:21', '2011-07-20 23:42:34', '');
INSERT INTO `user` VALUES('blozano', 'Betania Lozano', 'Madrid', 'betanialozano@yahoo.com', '5ddcbe4a9c36ba3bd05ea0eb8d4f09ed422f5139', 'Gestora Cultura. Co-directora de la Muestra IN-SONORA', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('bramos', 'Beatriz Ramos', 'Madrid', 'beatriz@iniciativajovn.org', '7e6d5e13cc911119538fd2a00e5900e37df9a711', 'TÃ©cnico de proyectos', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 20:48:57', '');
INSERT INTO `user` VALUES('bsampayo', 'Blanca Sampayo', 'Madrid', 'blancasampayo@gmail.com', 'bf3d17a170f915f2f0df09f33ecdb8ec4883648d', 'Estoy haciendo un Master de GestiÃ³n Cultural, y un curso de InnovaciÃ³n Abierta en GestiÃ³n Cultural,', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
...
INSERT INTO `user` VALUES('carlaboserman', 'Carla Boserman', 'Sevilla', 'carlaboserman@gmail.com', 'df9b92ece4cebf81da2789d7a55d949fe1bb5a69', '', '', 1, 0, '', '', '', '', NULL, '', 1, '0000-00-00 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('ccarrera', 'Candela Carrera', 'Barcelona', 'candela.carrera@gmail.com', 'dd7d71c995d705193cf659f5019eca491f7ad8ef', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('ccriado', 'Carlos Criado', 'CÃ¡ceres', 'carlos@carloscriado.es', 'dfce3f8d5e9722b20d20fe9fca259927d37e6856', 'FotoExtremadura', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('cmartinez', 'Cayetana Martinez', 'Madrid', 'cayetana109@gmail.com', '21470b6c5d5fd7c86af61904cfa25095184b0693', 'gestiÃ³n cultural. Trabajo con varias asociaciones culturales y de emprendedores y querrÃ­a conocer mÃ¡s de estas nuevas formas de financiaciÃ³n y organizaciÃ³n.', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('cphernandez', 'Claudia Patricia HernÃ¡ndez', 'Madrid', 'patriciavergara83@hotmail.com', '556be5beee418fda6e1601867ef3fd3395b80f7f', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('cpinero', 'Carlos PiÃ±ero Medina', 'CÃ¡ceres', 'innovacion@energiaextremadura.org', '2a22c481b606f2758f06762925c06e6cf4b5ca6e', 'Cluster de la EnergÃ­a de Extremadura. Dpto. de I+D+i y formaciÃ³n. ', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-07-05 01:54:45', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('criera', 'Cristina Riera ', 'Barcelona', 'criera@transit.es', 'a37535b1bb821dbc5495ddd55ddd04b9b4f485ed', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:15', '');
INSERT INTO `user` VALUES('dcabo', 'David Cabo', 'Madrid', 'david.cabo@gmail.com', '2e0b97b278aaadfdda6c1c5963212f28c9e59796', 'Ayudando a ONG Pro Bono Publico', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('elopez', 'Elvira LÃ³pez', 'Madrid', 'elvirilay@hotmail.com', '1d1d375939c74c8f755355f731c9eed3b4ee4297', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('emonivas', 'Esther MoÃ±ivas', 'Madrid', 'esther.monivas@gmail.com', '516d9ae4faac6f1425ef5fb0327d6bbb7948ea0b', 'Codirectora de la ONG AcciÃ³n C', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-07-05 01:55:04', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('eportillo', 'Esperanza Portillo', 'Madrid', 'portillo.esperanza@gmail.com', '549777e061b8dbadd683ca5293444f4095beaabf', 'Estudiante de master en gestiÃ³n cultural', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('esenabre', 'esenabre', 'Barcelona', 'esenabre@gmail.com', '60ffeee026521957cfd8585edf4b07e1541f640c', 'Livingg la vida loca', 'salud', 1, 27, 'Este campo va fuera', 'http://twitter.com/esenabre', 'http://www.facebook.com/esenabre', '', NULL, 'http://www.linkedin.com/in/esenabre', 1, '2011-06-15 11:33:12', '2011-07-14 20:24:08', '60109fe996530911ff113b9b1b55382f');
INSERT INTO `user` VALUES('evandellos', 'Emma VandellÃ³s ', 'Barcelona', 'emma.vandellos@esade.edu', 'f4ba05222b034f22339c7fb0ef299b925f02dcc8', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:15', '');
...
INSERT INTO `user` VALUES('fcingolani', 'Francesco Cingolani', 'Madrid', 'fc@ecosistemaurbano.com', '2c6abab20f50218be59a8d2d62c100a9dc9d3a08', 'Arquitecto. Soy responsable de Urban Social Design Experience, un proyecto de networked learning promovido por la asociaciÃ³n Urban Social Design', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:15', '');
INSERT INTO `user` VALUES('fcoddou', 'Flavio Coddou', 'Barcelona', 'flaviocoddou@gmail.com', '3e61f6f52ca6136091ced69b745d79fd88e58f71', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:15', '');
INSERT INTO `user` VALUES('ffreitas', 'Flavia Freitas', 'Barcelona', 'flavia.frr@gmail.com', '023434d501234549299f47c90b37249b8544b7b5', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('fingrassia', 'Franco Ingrassia', 'Rosario', 'francoingrassia@gmail.com', '3e990f6eee34056154296953598b61d10d9c55f3', 'PsicÃ³logo. Involucrado en el proceso de constituciÃ³n de un Laboratorio del ProcomÃºn en la ciudad de Rosario (Argentina)', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('gbento', 'Gisele Bento', 'Barcelona', 'giselecultura@gmail.com', '1d0bee13a33f3ce2fcc7b8c83596c903c9d5a42d', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('gbezanilla', 'Gerardo Bezanilla', 'Madrid', 'gerardo@beusual.com', 'bda58288e44e1011c2cf94ebe4582662f9876497', 'DiseÃ±ador, Editor, Agente Cultural', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('gbossio', 'Gabriela Bossio', 'Madrid', 'gabrielabossio@gmail.com', '9e832ab9a645262404ca0e44b6616aca990b5fec', 'Directora Creativa y Gestora cultural de La casa del Ãrbol', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('goteo', 'Goteo Platoniq', 'mhkjghsdkj fkj sadkjf', 'goteo@doukeshi.org', 'b57a92c9a6501f4542d670f2a13e98287fc596ca', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'EconomÃ­a distribuida, Comunidades / Redes, InnovaciÃ³n social, TICs, CreaciÃ³n de redes, Prosumidores, Monedas complementarias, Redes sociales', 1, 107, '* BÃºsqueda y anÃ¡lisis de experiencias y herramientas que sirvan de modelo.\r\n* AsesorÃ­as tÃ©cnicas (seguridad en la red), legales y administrativas.\r\n* Crear las bases para desarrollar un prototipo.', 'platoniq', 'platoniq', 'facebook', 'google', 'platoniq', 5, '2011-05-20 01:44:15', '2011-07-20 10:52:21', '8eefe6e871cebe24248cc47d4b23d152goteo@doukeshi.org');
INSERT INTO `user` VALUES('gpedranti', 'Gabriela Pedranti', 'Barcelona', 'info@gabrielapedranti.com', '1d2a5c9df4290c12a5f5962e3d9fda38c85c072d', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
...
INSERT INTO `user` VALUES('ibelloso', 'Isabel Belloso Bueno', 'CÃ¡ceres', 'ibellosobueso@yahoo.es', '00aff3cc9ed53bd857a28d4f0e209e5fac70ca5d', 'FundaciÃ³n CÃ¡ceres Capital', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:30:27', '');
...
INSERT INTO `user` VALUES('iromero', 'Imma Romero', 'Barcelona', 'ima_gina7@hotmail.com', 'ff5e6b74613597bfeaa59b91f9accc1d238cfefb', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('jlespina', 'JosÃ© Luis Espina', 'Barcelona', 'espinajl@gmail.com', '7bf9458b0c0549d310203f27c34f441ac074eb5a', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('jmatadero', 'Javi de Matadero', 'Madrid', 'javi@mataderomadrid.org', 'cb218e4b9fbbb89ec5804ec32ca1067e3679b311', 'Matadero', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('jmorer', 'Julia  Morer ', 'Madrid', 'julia.morer@gmail.com', '7b63000191f052ebb77324fe9940af29e9ad1765', 'EdiciÃ³n y DiseÃ±o de Proyectos Culturales', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 20:48:57', '');
...
INSERT INTO `user` VALUES('jnora', 'JuliÃ¡n Nora', 'Madrid', 'nora_julian@hotmail.com', '2eda3d6278dc18275918ea9ef18c0bdfe1c22a47', 'Ing. Simulacion ', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
...
INSERT INTO `user` VALUES('kventura', 'Kenia Ventura', 'Barcelona', 'dinkha@hotmail.com', '4e79b02993b50bddf2709ee5e764dfddc1c7661b', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('lcarretero', 'LucÃ­a Carretero', 'Barcelona', 'foto@luciacarretero.com', '29afdee54be1bbdf89242d5eb3cacf0c11b680f3', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('lemontero', 'Luis Ernesto Montero', 'CÃ¡ceres', ' lernestomc@Yahoo.es', 'b0e4f357e65a33966d2089b1d899f4245f05ad25', 'Artista', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('lfernandez', 'Laura FernÃ¡ndez', 'Madrid', 'laura@medialab-prado.es', '6823d091412f0850015e9a0e4983b48063e7a813', 'Responsable de programa cultural en Medialab-Prado', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('lstalling', 'Lars Stalling', 'Barcelona', 'larsst@gmail.com ', 'dbe4f8a3757235145f8ed0fde23e433fe5650872', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('maaban', 'Manuel Ãngel AbÃ¡n', 'Madrid', 'manuel.aban@gmail.com', 'd068342a85c48d2f95ea7661b2b0a5e77c56dc5c', 'Codirector de una ONG ', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('mduran', 'Magdalena Duran', 'Barcelona', 'magdaduran@yahoo.es', '5d5d2e7dfde93f13cc12abdacc10d7f2083f1c39', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('mgarcia', 'Miriam GarcÃ­a Sanz', 'Madrid', 'miriamgsanz@gmail.com', 'b982ca393b19498409bc749abefc585e14dc149f', 'Gestora cultural', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('mkekejian', 'Maral Kekejian ', 'Madrid', 'mkekejih@cajamadrid.es', '6bab1571a22fa60c8022a6dfcf397f97b0743279', 'Artes EscÃ©nicas LCE', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('mmikirdistan', 'Maral Mikirdistan', 'Barcelona', 'idensitat@idensitat.org', 'c63a6cb1c60e71b3a9f0d90a02ee392ff1a779ce', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('mpalma', 'Marcela Palma Barrera', 'CÃ¡ceres', 'marcela.palma@fundacionciudadania.es', 'c6f3a28e89b2b5f6e6f191eb533676f6cea595bf', 'FundaciÃ³n CiudadanÃ­a', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('mpedroche', 'Mercedes Pedroche', 'Madrid', 'info@mercedespedroche.com', '570d6dc480ffbe1388e1bedce96e5a0e57e502b8', 'CoreÃ³grafa, bailarina', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('mramirez', 'Miguel RamÃ­rez', 'Barcelona', 'miquel.ramirez@gmail.com', 'f223dbfb37ae5507cdb7ced8d338e05a686bf25a', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('nescala', 'Nella Escala', 'Barcelona', 'nella.escala@gmail.com', '4ee7c6e03aaa371e7f3ee8dcaedd0d1f23a374da', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
...
INSERT INTO `user` VALUES('pgonzalo', 'Pilar Gonzalo', 'Madrid', 'pilar.gonzalo@fulbrightmail.org', '2675dc74abf73a42520c10bcfad2cdca66a6f1c0', 'Museo Reina SofÃ­a', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:15', '');
INSERT INTO `user` VALUES('rcasado', 'Raul Casado', 'Barcelona', 'raul.casadogonzalez@gmail.com', '060d5b91ab484ba5bbd937c3cf23bd864ccba3d0', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('root', 'Super administrador', '', 'julian_1302552287_per@gmail.com', '4228a4f6ed3e4dc7b6a00c67cbe519b083fddd40', '', '', 1, NULL, '', '', '', '', '', '', 2, '2011-07-20 16:26:50', '2011-07-22 19:38:19', '61aa85ea9169c68babfa5b8bdb44097bjulian_1302552287_per@gmail.com');
INSERT INTO `user` VALUES('rparramon', 'Ramon Parramon', 'Barcelona', 'rparramon@acvic.org', '98de9c0d4367d83c6b18bac6e0010972261aa094', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('rsalas', 'Roberto Salas', 'Madrid', 'robers_alas@yahoo.es', '86a131eb71ceceddb26bc889895cf24ef96602e1', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
...
INSERT INTO `user` VALUES('sgrueso', 'StÃ©phane Grueso', 'Madrid', 'stephanegrueso@gmail.com', '2364b268a16831f859c5d17b7eda329fd39700a9', 'Cineasta documental', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('smeschede', 'SÃ¶ren Meschede', 'Madrid', 'soren@hablarenarte.com', '0b63ad3f4d744a320cf437f1ffecb4c24a74f74f', 'Gestor Cultural', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
...
INSERT INTO `user` VALUES('stena', 'Sara Tena Medina', 'CÃ¡ceres', 'sara.tena@aupex.org', 'e0be7b9f868042ae4e89136b9a84996597ba5b44', 'AsociaciÃ³n de Universidades Populares de Extremadura', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('tbadia', 'Tere Badia', 'Barcelona', 'tbadtod@gmail.com', '770b0c2422f238ff6662d2411900c6e57f130e22', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
INSERT INTO `user` VALUES('tguido', 'TomÃ¡s Guido', 'Madrid', 'tguido@transit.es', '325dce990aec945b7d843814911ae7811670dbee', 'Coordino la oficina en Madrid la empresa TrÃ nsit Projectes. www.transit.es', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user` VALUES('vsantiago', 'Victor Santiago', 'CÃ¡ceres', 'vstabares@gmail.com', '62ff5323c5bb06d521efb2f1f185389728d715a2', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('vtorre', 'VÃ­ctor Torre', 'Madrid', 'victortorrevaquero@yahoo.es', '09723c5bf0daf4c5c5b127ba269edc841327238c', 'Coordinador Teatro Sol y Tierra', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 18:23:16', '');
INSERT INTO `user` VALUES('yriquelme', 'Yolanda Riquelme ', 'Madrid', 'yolandariquel@hotmail.com', 'add40e3392132f436c194831fa81de1dd3b62962', '', '', 1, 0, '', '', '', '', NULL, '', 1, '2011-05-04 00:00:00', '2011-07-15 17:07:52', '');
...
INSERT INTO `user_image` VALUES('betatester', 4);
INSERT INTO `user_image` VALUES('betatester', 68);
INSERT INTO `user_image` VALUES('betatester', 72);
INSERT INTO `user_image` VALUES('diegobus', 8);
INSERT INTO `user_image` VALUES('esenabre', 27);
INSERT INTO `user_image` VALUES('goteo', 75);
INSERT INTO `user_image` VALUES('goteo', 80);
INSERT INTO `user_image` VALUES('goteo', 81);
INSERT INTO `user_image` VALUES('goteo', 82);
INSERT INTO `user_image` VALUES('goteo', 83);
INSERT INTO `user_image` VALUES('goteo', 84);
INSERT INTO `user_image` VALUES('goteo', 85);
INSERT INTO `user_image` VALUES('goteo', 86);
INSERT INTO `user_image` VALUES('goteo', 87);
INSERT INTO `user_image` VALUES('goteo', 88);
INSERT INTO `user_image` VALUES('goteo', 89);
INSERT INTO `user_image` VALUES('goteo', 90);
INSERT INTO `user_image` VALUES('goteo', 91);
INSERT INTO `user_image` VALUES('goteo', 92);
INSERT INTO `user_image` VALUES('goteo', 93);
INSERT INTO `user_image` VALUES('goteo', 94);
INSERT INTO `user_image` VALUES('goteo', 95);
INSERT INTO `user_image` VALUES('goteo', 96);
INSERT INTO `user_image` VALUES('goteo', 97);
INSERT INTO `user_image` VALUES('goteo', 98);
INSERT INTO `user_image` VALUES('goteo', 99);
INSERT INTO `user_image` VALUES('goteo', 107);
...
INSERT INTO `user_interest` VALUES('betatester', 2);
INSERT INTO `user_interest` VALUES('betatester', 6);
INSERT INTO `user_interest` VALUES('esenabre', 7);
INSERT INTO `user_interest` VALUES('goteo', 1);
INSERT INTO `user_interest` VALUES('goteo', 2);
INSERT INTO `user_interest` VALUES('goteo', 6);
INSERT INTO `user_interest` VALUES('goteo', 7);
INSERT INTO `user_interest` VALUES('goteo', 9);
INSERT INTO `user_interest` VALUES('goteo', 13);
...
INSERT INTO `user_personal` VALUES('betatester', 'eric cantona', NULL, '7777777777', NULL, '65552584', 'manchester 2004', '333333', 'liverpool', 'england');
...
INSERT INTO `user_personal` VALUES('goteo', 'Goteo Platoniq', NULL, '', NULL, '', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃ±a');
...
INSERT INTO `user_role` VALUES('betatester', 'user', '*');
...
CREATE TABLE `user_web` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Webs de los usuarios' AUTO_INCREMENT=41 ;

--
-- Volcar la base de datos para la tabla `user_web`
--

INSERT INTO `user_web` VALUES(18, 'root', 'http://asdf.com');
INSERT INTO `user_web` VALUES(23, 'root', 'http://');
INSERT INTO `user_web` VALUES(24, 'root', 'http://');
INSERT INTO `user_web` VALUES(34, 'goteo', 'http://sdfa gadf');
INSERT INTO `user_web` VALUES(39, 'goteo', 'http://');
INSERT INTO `user_web` VALUES(40, 'goteo', 'http://');
