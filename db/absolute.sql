...
--
-- Servidor: localhost
-- Tiempo de generación: 13-09-2011 a las 20:48:19
...
INSERT INTO `glossary` VALUES(1, 'Capital riego', 'El capital riego (como riesgo pero sin ese :) es la manera de llamar a nuestro particular método de financiación por goteo. Un proceso de captación de recursos colectivos de forma distribuida, “gota a gota”, para la optimización de la inversión y su retorno en beneficio del mayor número posible de personas.', '', NULL);
...
INSERT INTO `glossary` VALUES(7, 'Nodo', 'Un nodo es un lugar en el que confluyen parte de las conexiones de una red compuesta a su vez por nodos, que se interrelacionan de un modo centralizado, descentralizado o distribuido.', '', NULL);
INSERT INTO `glossary` VALUES(8, 'Procomún (commons)', 'El <a href="http://es.wikipedia.org/wiki/Bien_comunal" target="_blank">procomún</a> (traducción al castellano del commons anglosajón), es la manera de producir y gestionar en comunidad, de manera pública y colectiva, bienes y recursos comunes, tangibles e intangibles, que nos pertenecen y pueden ser libremente utilizados por tod*s y entre tod*s deben ser ampliados y preservados. Un modelo de gobernanza co-responsable, basado en la comunidad, la confianza, la transparencia, el trabajo solidario, el intercambio entre iguales o el acceso universal.\r\n\r\nLos bienes y recursos comunes que conforman el procomún, son aquellos que heredamos, creamos y re-creamos conjuntamente y que esperamos legar a las generaciones futuras. Una gran diversidad de bienes naturales, culturales o sociales, como por ejemplo: las semillas, Internet, el folclore, el agua potable, el genoma, el espacio público, el conocimiento, etc. Bienes y recursos que muchas veces sólo percibimos cuando están amenazados o en peligro de desaparición o privatización. Por ese motivo creemos, junto a mucha otra gente, que es importante fomentarlos y reforzarlos activamente, (re)descubriendo el procomún en las posibilidades de Internet y lo digital pero también en el uso de nuevos lugares donde queremos vivir y trabajar; o en el vasto mundo de la educación, donde tanto urge innovar; o en nuevos modos de producción y distribución de alimentos ecológicos y la preservación del medio ambiente en general; por citar sólo algunas áreas de las muchas que se deben explorar.\r\n\r\nEl concepto de procomún, es un antiguo concepto jurídico-filosófico, que en los últimos años ha vuelto a tomar impulso, vigencia y repercusión pública, gracias al desarrollo del conocimiento libre y el movimiento open source desde el software libre, a la proliferación de licencias como Creative Commons, o al premio Nobel de Economía concedido a Elinor Ostrom en 2009, por sus aportaciones al gobierno de los bienes comunes.', 'http://www.youtube.com/watch?v=YRh6SUnOW0A', NULL);
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=28 ;
...
INSERT INTO `invest` VALUES(10, 'paypal', 'fixie-per-tothom', 'paypal_1315159211_per@gmail.com', 100, 0, NULL, NULL, '2011-09-08', NULL, NULL, 'PA-78D62470FN745081M', NULL, NULL, 'paypal', NULL, NULL);
...
INSERT INTO `invest` VALUES(23, 'goteo', 'tweetometro', 'goteo@doukeshi.org', 100, 0, NULL, NULL, '2011-09-09', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(24, 'goteo', 'tweetometro', 'goteo@doukeshi.org', 100, 0, NULL, NULL, '2011-09-09', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(25, 'goteo', 'tweetometro', 'goteo@doukeshi.org', 2000, 0, NULL, NULL, '2011-09-09', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(26, 'root', 'fixie-per-tothom', 'goteo_root@doukeshi.org', 100, 0, NULL, NULL, '2011-09-12', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(27, 'asanz', 'fixie-per-tothom', 'asanzgr@hotmail.com', 50, 1, NULL, 1, '2011-09-12', '2011-09-12', NULL, NULL, NULL, NULL, 'cash', 'root', NULL);
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mensajes de usuarios en proyecto' AUTO_INCREMENT=145 ;
...
INSERT INTO `message` VALUES(136, 'diegobus', 'fixie-per-tothom', NULL, '2011-09-08 17:16:51', 'Espacio taller: Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 1, 0);
...
CREATE TABLE `promote` (
  ...
  UNIQUE KEY `project_node` (`node`,`project`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Proyectos destacados' AUTO_INCREMENT=10 ;
...
INSERT INTO `promote` VALUES(9, 'goteo', 'tweetometro', 'Recompensas', 'superan el limite?', 2);
...
INSERT INTO `purpose` VALUES('invest-payment-email', 'Introduce tu cuenta de PayPal o tu email (si usas targeta de crédito)', NULL, 'invest');
...
INSERT INTO `purpose` VALUES('mandatory-project-field-contract_birthdate', 'Es obligatorio poner la fecha de nacimiento de la persona física', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('mandatory-project-field-contract_nif', 'Es obligatorio poner el documento de identificacción de la/el responsable del proyecto.', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('mandatory-project-field-entity_name', 'Es obligatorio poner la denominación social de la entidad jurídica', NULL, 'personal');
INSERT INTO `purpose` VALUES('mandatory-project-field-entity_office', 'Es obligatorio poner el cargo en la organización del responsable', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('personal-field-contract_data', 'Datos del responsable del proyecto', NULL, 'personal');
INSERT INTO `purpose` VALUES('personal-field-contract_email', 'Email asociado al proyecto', NULL, 'personal');
INSERT INTO `purpose` VALUES('personal-field-contract_entity', 'Tipo de persona que representa al proyecto', NULL, 'personal');
INSERT INTO `purpose` VALUES('personal-field-contract_entity-entity', 'Entidad jurídica', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('personal-field-entity_name', 'Denominación social de la entidad', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('tooltip-project-contract_birthdate', 'Consejo para rellenar la fecha de nacimiento', NULL, 'personal');
INSERT INTO `purpose` VALUES('tooltip-project-contract_data', 'Consejo para rellenar los datos del responsable del proyecto', NULL, 'personal');
INSERT INTO `purpose` VALUES('tooltip-project-contract_email', 'Consejo para rellenar el email asociado al proyecto', NULL, 'personal');
INSERT INTO `purpose` VALUES('tooltip-project-contract_entity', 'Consejo para rellenar el tipo de persona que representa al proyecto', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('tooltip-project-entity_cif', 'Consejo para rellenar el CIF de la entidad', NULL, 'personal');
INSERT INTO `purpose` VALUES('tooltip-project-entity_name', 'Consejo para rellenar la denominación social de la entidad', NULL, 'personal');
INSERT INTO `purpose` VALUES('tooltip-project-entity_office', 'Consejo para rellenar el cargo en la organización', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('tooltip-project-main_address', 'Consejo para rellenar el domicilio fiscal', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('tooltip-project-post_address', 'Consejo para rellenar el domicilio postal', NULL, 'personal');
...
INSERT INTO `purpose` VALUES('validate-project-value-contract_email', 'El EMAIL no es correcto.', NULL, 'register');
...
CREATE TABLE `reward` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Retornos colectivos e individuales' AUTO_INCREMENT=238 ;
...
INSERT INTO `reward` VALUES(73, '2c667d6a62707f369bad654174116a1e', 'codigo GPL', 'código', 'social', 'other', '', NULL, 0, 0, 0);
...
INSERT INTO `reward` VALUES(158, '2c667d6a62707f369bad654174116a1e', 'aqui hay un problema veras', 'aqui hay un problema veras', 'individual', 'other', '', '', 10, 0, 0);
...
INSERT INTO `support` VALUES(23, 'fixie-per-tothom', 'Espacio taller', 'Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 'lend', 136);
INSERT INTO `support` VALUES(28, '2c667d6a62707f369bad654174116a1e', 'pincel', 'pinceles', 'lend', 137);
INSERT INTO `support` VALUES(29, '2c667d6a62707f369bad654174116a1e', 'alguin q sepa escribir', 'redactar textos', 'task', 138);
INSERT INTO `support` VALUES(34, '2c667d6a62707f369bad654174116a1e', 'nueva colab editada desde el dahboard proyecto BROOKLYN', 'a ver si se ve', 'task', 139);
INSERT INTO `support` VALUES(38, 'pliegos', 'Pilas', 'Dejadmelas :)', 'lend', 75);
INSERT INTO `support` VALUES(43, '2c667d6a62707f369bad654174116a1e', 'ayuda para poner en marcha este ajax!!!', 'ayuda para poner en marcha este ajax!!!', 'task', 140);
INSERT INTO `support` VALUES(48, '2c667d6a62707f369bad654174116a1e', 'Nueva tarea', 'una tarea guay', 'task', 141);
...
INSERT INTO `support` VALUES(72, '2c667d6a62707f369bad654174116a1e', 'TAREA DESDE DASHBOAR', 'FUNCIONA', 'task', 142);
...
INSERT INTO `template` VALUES(1, 'Mensaje de contacto', 'Plantilla para un mensaje de contacto desde Goteo', 'Contacto desde Goteo: %SUBJECT%', 'Hola %TONAME%, \r\n\r\nÉste es un mensaje de contacto enviado por %USEREMAIL% desde Goteo.org:\r\n\r\n%MESSAGE%\r\n\r\n--\r\n\r\nThe Goteo Mailer');
INSERT INTO `template` VALUES(2, 'Mensaje a los cofinanciadores', 'Plantilla del mensaje masivo a cofinanciadores desde dashboard - gestión de retornos', 'Mensaje del proyecto %PROJECTNAME%', 'Hola %NAME%, \r\n\r\nÉste es un mensaje enviado desde la plataforma de Goteo por parte de quien impulsa el proyecto %PROJECTNAME%:\r\n\r\n%MESSAGE%\r\n\r\nTe recordamos que puedes acceder a la página de %PROJECTNAME% en Goteo desde la siguiente URL: \r\n\r\n%PROJECTURL%\r\n\r\n--\r\n\r\nThe Goteo Mailer');
INSERT INTO `template` VALUES(3, 'Mensaje al autor', 'Plantilla del mensaje al autor después de aportar a su proyecto', 'Mensaje de un/a cofinanciador/a de %PROJECTNAME%', 'Hola %OWNERNAME%!\r\n\r\nÉste es un mensaje enviado desde Goteo por %USERNAME%:\r\n\r\n%MESSAGE%\r\n\r\nTe recordamos que puedes ver quién cofinancia el proyecto %PROJECTNAME% desde tu panel de control:\r\n\r\n %SITEURL%/dashboard\r\n\r\n--\r\n\r\nThe Goteo Mailer');
INSERT INTO `template` VALUES(4, 'Mensaje entre usuarios', 'Mensaje de un usuario a otro desde la página de perfil del destinatario', 'Mensaje personal de %USERNAME% desde Goteo', 'Hola %TONAME%, \r\n\r\nÉste es un mensaje enviado por %USERNAME% desde Goteo:\r\n\r\n%MESSAGE%\r\n\r\nTe recordamos que puedes ver la gente con la que estás en contacto desde Goteo en tu perfil:\r\n\r\n%PROFILEURL%\r\n\r\n--\r\n\r\nThe Goteo Mailer');
INSERT INTO `template` VALUES(5, 'Confirmación de registro', 'Plantilla del mensaje de confirmación de registro', 'Confirmación de usuario en Goteo', 'Hola %USERNAME%!\r\n\r\nGracias por registrarte en Goteo, tu cuenta ha sido creada con éxito :)\r\n\r\nPara confirmar tu dirección de correo electrónico y completar el registro, haz clic en el siguiente enlace (o cópialo en la barra de dirección del navegador):\r\n\r\n%ACTIVATEURL%\r\n\r\nRecuerda que tu login es <strong>%USERID%</strong>. Una vez se active tu cuenta podrás acceder a http://goteo.org/ y comenzar a utilizar la plataforma para apoyar o proponer proyectos.\r\n\r\n(En caso de que no hayas has solicitado este registro, uhm... ignora este mensaje).\r\n\r\n--\r\n\r\nThe Goteo Mailer');
INSERT INTO `template` VALUES(6, 'Recuperar contraseña', 'Plantilla para el mensaje al solicitar la recuperación de cotnraseña', 'Petición de recuperación de contraseña en Goteo', 'Hola %USERNAME%:\r\n\r\nHemos recibido una petición para recuperar la contraseña de tu cuenta de usuario en http://goteo.org/\r\n\r\nPara acceder a tu cuenta y cambiar la contraseña debes introducir tu login como contraseña actual, a través del siguiente enlace:\r\n\r\n%RECOVERURL%\r\n\r\nSi no puedes hacer click, cópialo y pégalo en el navegador.\r\n\r\nRecuerda que tu login es <strong>%USERID%</strong>, úsalo como contraseña actual para poder cambiarla a continuación.\r\n\r\n(En caso de que no hayas has solicitado este cambio de contraseña, uhm... ignora este mensaje).\r\n\r\n--\r\n\r\nThe Goteo Mailer');
INSERT INTO `template` VALUES(7, 'Cambio de email', 'Plantilla del mensaje al cambiar el email', 'Petición de cambio de email en Goteo', 'Hola %USERNAME%,\r\n\r\nHemos recibido una petición para cambiar el email de tu cuenta de usuario en Goteo.org\r\n\r\nPara confirmar la propiedad de tu nueva dirección de correo electrónico, haz clic en el siguiente enlace (o cópialo en la barra de dirección del navegador):\r\n\r\n%CHANGEURL%\r\n\r\nEste proceso es necesario para confirmar la propiedad de la dirección de correo electrónico, así que no podrás operar con esta dirección hasta que la hayas confirmado.\r\n\r\n--\r\n\r\nThe Goteo Mailer');
INSERT INTO `template` VALUES(8, 'Confirmacion de proyecto enviado', 'Mensaje al usuario cuando envia un proyecto a revisión desde el preview del formulario', 'El proyecto %PROJECTNAME% ha pasado a fase de valoración', 'Hola %USERNAME%,\r\n\r\nHemos recibido la petición de revisar el proyecto %PROJECTNAME% para valorar su publicación y promoción mediante Goteo. \r\n\r\nEn breve alguien del equipo se pondrá en contacto contigo al respecto ok? \r\n\r\nPuedes encontrar más información sobre el proceso de revisión de proyectos en nuestras FAQ: http://beta.goteo.org/faq#q88\r\n\r\nMuchas gracias por tu tiempo!\r\n\r\n--\r\n\r\nThe Goteo Mailer');
...
INSERT INTO `user` VALUES('abenitez', 'Alba Benitez', 'Cáceres', 'albabenitez1983@gmail.com', 'ccb39ea899a2dbc60867cfec2495ffcbfb2eb42d', 'Autónoma-Sector cultural', '', 1, 0, '', '', '', '', '', '', 2, '2011-05-04 00:00:00', '2011-09-09 17:03:30', '', 0);
...
INSERT INTO `user` VALUES('ahernandez', 'Alejandro Hernández Renner', 'Cáceres', 'ahernandez@lossantos.org', '79dd1d71cb13c723ac077e636c47d14720498b4c', 'Director Fundación Maimona', '', 1, 0, '', '', '', '', '', '', 3, '2011-05-04 00:00:00', '2011-09-09 17:03:30', '', 0);
...
INSERT INTO `user` VALUES('amorales', 'Ana Morales', 'Madrid', 'moralespartida@gmail.com', 'e8396d7fc730a83111aa251a80d44e4295d15d85', 'Trabajo en temas culturales', '', 1, 0, '', '', '', NULL, '', '', 3, '2011-05-04 00:00:00', '2011-09-09 17:03:30', '', 0);
INSERT INTO `user` VALUES('amunoz', 'Ascensión Muñoz Benítez', 'Cáceres', 'chonmube@gmail.com', '18542a1914f496a4c66739483a45620edfc40a65', 'Autónoma-Gestora cultural', '', 1, 0, '', '', '', NULL, '', '', 3, '2011-07-05 01:54:33', '2011-09-08 19:05:50', '', 0);
...
INSERT INTO `user` VALUES('asanz', 'Ana Sánz Grados', 'Cáceres', 'asanzgr@hotmail.com', 'a32009cc0d01b5a96aced6cff6cf4be61e8fbd7c', 'Asociación de Mujeres Malvaluna', '', 1, 0, '', '', '', NULL, '', '', 2, '2011-05-04 00:00:00', '2011-09-13 07:59:41', '', 0);
...
INSERT INTO `user` VALUES('carlaboserman', 'Carla Boserman', 'Sevilla', 'carlaboserman@gmail.com', 'df9b92ece4cebf81da2789d7a55d949fe1bb5a69', '', '', 1, 0, '', '', '', NULL, '', '', 3, '0000-00-00 00:00:00', '2011-09-09 17:03:30', '', 0);
...
INSERT INTO `user` VALUES('gnarros', 'Germán Narros Lluch', 'Cáceres', 'german@caceresentumano.com', '5a6eb69bae6b03a73d6956552e21ea0ce515e878', 'caceresentumano.com', '', 1, 0, '', '', '', NULL, '', '', 3, '2011-05-04 00:00:00', '2011-09-09 17:03:30', '', 0);
INSERT INTO `user` VALUES('goteo', 'Goteo', 'Barcelona', 'goteo@doukeshi.org', 'b57a92c9a6501f4542d670f2a13e98287fc596ca', 'Este perfil representa al equipo que administra la plataforma Goteo, desde el cual nos comunicamos con todos los usarios.', '', 1, 118, '', 'http://twitter.com/#!/goteofunding', '', '', 'http://identi.ca/goteofunding', '', 5, '2011-08-05 10:15:42', '2011-09-09 18:07:23', '8eefe6e871cebe24248cc47d4b23d152goteo@doukeshi.org', 0);
...
INSERT INTO `user` VALUES('root', 'Super administrador', '', 'goteo_root@doukeshi.org', 'f64dd0d8c9276d87c6d0ae24c5d12571c62ecf16', '', '', 1, 91, '', '', '', '', '', '', 0, '2011-09-01 19:17:43', '2011-09-12 18:05:17', '61aa85ea9169c68babfa5b8bdb44097bjulian_1302552287_per@gmail.com', 1);
...
INSERT INTO `user_personal` VALUES('olivier', 'Johny Cash dsf sadf', NULL, 'G63306914', NULL, '+34 932 0', 'C/ Montalegre, 5', '08001', 'Barcelona', 'España');
...
CREATE TABLE `user_web` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Webs de los usuarios' AUTO_INCREMENT=42 ;
...
INSERT INTO `user_web` VALUES(40, 'olivier', 'http://');
