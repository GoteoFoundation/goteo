...
--
-- Servidor: localhost
-- Tiempo de generación: 15-07-2011 a las 12:25:56
...
INSERT INTO `acl` VALUES(52, '*', 'user', 'goteo', '/project/edit/585e2df96b057aacfb482ed6bb7493e1/', 1, '2011-07-14 23:35:55');
INSERT INTO `acl` VALUES(53, '*', 'user', 'goteo', '/project/delete/585e2df96b057aacfb482ed6bb7493e1/', 1, '2011-07-14 23:35:55');
...
CREATE TABLE `cost` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Desglose de costes de proyectos' AUTO_INCREMENT=146 ;
...
INSERT INTO `cost` VALUES(145, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nueva tarea', NULL, 'task', NULL, 1, '2011-07-15', '2011-07-15');
...
INSERT INTO `icon` VALUES('service', 'Servicios', 'Servicios', NULL, 0);
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mensajes de usuarios en proyecto' AUTO_INCREMENT=8 ;
...
INSERT INTO `message` VALUES(7, 'goteo', '43b8c28144ad2a9687374e95ae9ac4d6', NULL, '2011-07-15 03:14:24', 'Nueva colaboraciÃ³n: g dfg dfg dg ', 1, 0);
...
CREATE TABLE `post` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Entradas para la portada' AUTO_INCREMENT=9 ;
...
INSERT INTO `project` VALUES('2c667d6a62707f369bad654174116a1e', 'NO SLEEP TO BROOKLYN', 3, 67, 'olivier', 'goteo', 10, 4, '2011-05-12', '2011-07-04', '2011-06-09', NULL, NULL, '', '', '', '', '', '', '', '', 'te has despertado en NYC?', 'cyberpunk', 'una canciÃ³n de los beastie', 'cyberpunk', 'un monton de gente', NULL, 'educaciÃ³n, copyleft, manchego', 'http://vimeo.com/15153640', 3, 'paris', NULL, '', '');
...
INSERT INTO `project` VALUES('43b8c28144ad2a9687374e95ae9ac4d6', 'Mi proyecto 4', 1, 41, 'goteo', 'goteo', 0, 0, '2011-07-14', '2011-07-15', NULL, NULL, NULL, 'Goteo Platoniq', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, '', 'a', NULL, 'mhkjghsdkj fkj sadkjf', 2, '', NULL);
INSERT INTO `project` VALUES('585e2df96b057aacfb482ed6bb7493e1', 'Mi proyecto 7', 1, 27, 'goteo', 'goteo', 0, 0, '2011-07-14', NULL, NULL, NULL, NULL, 'Goteo Platoniq', '', '', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃƒÂ±a', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'mhkjghsdkj fkj sadkjf', NULL, NULL, NULL);
INSERT INTO `project` VALUES('5aca87da1aff996c6fb7abaddc947ae0', 'Mi proyecto 6', 1, 27, 'goteo', 'goteo', 0, 0, '2011-07-14', NULL, NULL, NULL, NULL, 'Goteo Platoniq', '', '', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃƒÂ±a', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'mhkjghsdkj fkj sadkjf', NULL, NULL, NULL);
INSERT INTO `project` VALUES('75a3d571ea3433f059c9196be05c3c8c', 'Nombre del proyecto', 1, 25, 'goteo', 'goteo', 0, 0, '2011-07-14', '2011-07-15', NULL, NULL, NULL, 'Goteo Platoniq', '', '', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃƒÂ±a', '', '', NULL, NULL, NULL, NULL, NULL, '', '', NULL, 'mhkjghsdkj fkj sadkjf', NULL, NULL, NULL);
...
INSERT INTO `project` VALUES('a565092b772c29abc1b92f999af2f2fb', 'Tweetometro', 3, 52, 'goteo', 'goteo', 0, 30, '2011-07-03', '2011-07-15', '2011-07-05', NULL, NULL, '', '', '', '', '', '', '', '', 'Plataforma experimental de votaciÃ³n mediante tweets. En alfa! Una aplicaciÃ³n para llegar a acuerdos, tomar decisiones colectivamente o elegir la mejor idea presentada, mediante twitter y sms (en desarrollo).', '', '', '', '', NULL, '', '', 0, '', 0, '', '');
INSERT INTO `project` VALUES('a9277be1c7e92eaa36ecae753231bfb1', 'Mi proyecto 3', 1, 50, 'goteo', 'goteo', 0, 0, '2011-07-11', '2011-07-13', NULL, NULL, NULL, 'Goteo Platoniq', '', '', '', '', 'mhkjghsdkj fkj sadkjf', 'EspaÃƒÂ±a', '', '', '', '', '', '', NULL, '', '', 1, 'Reikiavik', 4, '', NULL);
...
CREATE TABLE `reward` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Retornos colectivos e individuales' AUTO_INCREMENT=179 ;
...
INSERT INTO `reward` VALUES(165, 'goteo', 'De puta madre', 'La recompensa', 'individual', 'other', 'Esto es', NULL, 0, 0, 0);
...
INSERT INTO `reward` VALUES(177, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nuevo retorno colectivo', NULL, 'social', '', NULL, '', NULL, NULL, 0);
INSERT INTO `reward` VALUES(178, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nueva recompensa individual', NULL, 'individual', '', NULL, NULL, 0, 0, 0);
...
CREATE TABLE `support` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Colaboraciones' AUTO_INCREMENT=75 ;
...
INSERT INTO `support` VALUES(72, 'a9277be1c7e92eaa36ecae753231bfb1', 'Nueva colaboraciÃ³n', '', 'task', NULL);
INSERT INTO `support` VALUES(73, 'goteo', 'Nueva colaboraciÃ³n', '', 'task', NULL);
INSERT INTO `support` VALUES(74, '43b8c28144ad2a9687374e95ae9ac4d6', 'Nueva colaboraciÃ³n', 'g dfg dfg dg ', 'task', 7);
...
INSERT INTO `user` VALUES('aballesteros', 'AndrÃ©s Ballesteros', 'CÃ¡ceres', 'geopetro10@yahoo.es', '975b5f25e95d2afd7c22b50342ddffc5edba89a1', 'Abvmedioambiente', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('abenitez', 'Alba Benitez', 'CÃ¡ceres', 'albabenitez1983@gmail.com', 'ccb39ea899a2dbc60867cfec2495ffcbfb2eb42d', 'AutÃ³noma-Sector cultural', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('aceballos', 'Ana Ceballos', 'Madrid', 'veyota79@hotmail.com', 'db5c3952834c9f1a64f4086e94afa40013dd3a5b', 'Gestor Cultural', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('afernandez', 'Ana Fdez Osorio', 'Barcelona', 'ana@dispuesta.net', 'bc4b56d5b2fb0ddb27e4ba97ed8483c2b96b9b43', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('afolguera', 'Antonia Folguera', 'Barcelona', 'antonia@riereta.net', '232083fdb8d80ac58b79ab55b75d302e54b5038b', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('amartinez', 'Alfonso MartÃ­nez', 'Barcelona', 'martinezrubioo@gmail.com', 'b9ee4c65c2de3f007eef8e0cd9e39d2ef49aa17b', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('amorales', 'Ana Morales', 'Madrid', 'moralespartida@gmail.com', 'e8396d7fc730a83111aa251a80d44e4295d15d85', 'Trabajo en temas culturales', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('aollero', 'Ana  Ollero', 'CÃ¡ceres', 'programaskreativos@gmail.com', 'a1d29ffc56898468565d89a267fa13b40d396278', 'Programas creativos', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:30:28', '');
...
INSERT INTO `user` VALUES('arecio', 'Anto Recio', 'CÃ¡ceres', 'anto@filosomatika.net', '31d6347ed7f1809654680fb6f1bb5bed2ab07408', 'Fundecyt', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 23:15:25', '');
INSERT INTO `user` VALUES('asanz', 'Ana SÃ¡nz Grados', 'CÃ¡ceres', 'asanzgr@hotmail.com', 'a32009cc0d01b5a96aced6cff6cf4be61e8fbd7c', 'AsociaciÃ³n de Mujeres Malvaluna', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:30:28', '');
INSERT INTO `user` VALUES('avigara', 'Ana Vigara', 'Madrid', 'ana.vigara@iniciativajoven.org', 'b093c07f7a1c81bb216456e7cceb0520a632437f', 'TÃ©cnico de proyectos', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:16:46', '');
INSERT INTO `user` VALUES('blozano', 'Betania Lozano', 'Madrid', 'betanialozano@yahoo.com', '5ddcbe4a9c36ba3bd05ea0eb8d4f09ed422f5139', 'Gestora Cultura. Co-directora de la Muestra IN-SONORA', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('bramos', 'Beatriz Ramos', 'Madrid', 'beatriz@iniciativajovn.org', '7e6d5e13cc911119538fd2a00e5900e37df9a711', 'TÃ©cnico de proyectos', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:16:46', '');
INSERT INTO `user` VALUES('bsampayo', 'Blanca Sampayo', 'Madrid', 'blancasampayo@gmail.com', 'bf3d17a170f915f2f0df09f33ecdb8ec4883648d', 'Estoy haciendo un Master de GestiÃ³n Cultural, y un curso de InnovaciÃ³n Abierta en GestiÃ³n Cultural,', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
...
INSERT INTO `user` VALUES('carlaboserman', 'Carla Boserman', 'Sevilla', 'carlaboserman@gmail.com', 'df9b92ece4cebf81da2789d7a55d949fe1bb5a69', '', '', 1, 0, '', '', '', '', NULL, '', 0, '0000-00-00 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('ccarrera', 'Candela Carrera', 'Barcelona', 'candela.carrera@gmail.com', 'dd7d71c995d705193cf659f5019eca491f7ad8ef', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('cmartinez', 'Cayetana Martinez', 'Madrid', 'cayetana109@gmail.com', '21470b6c5d5fd7c86af61904cfa25095184b0693', 'gestiÃ³n cultural. Trabajo con varias asociaciones culturales y de emprendedores y querrÃ­a conocer mÃ¡s de estas nuevas formas de financiaciÃ³n y organizaciÃ³n.', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('cphernandez', 'Claudia Patricia HernÃ¡ndez', 'Madrid', 'patriciavergara83@hotmail.com', '556be5beee418fda6e1601867ef3fd3395b80f7f', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('criera', 'Cristina Riera ', 'Barcelona', 'criera@transit.es', 'a37535b1bb821dbc5495ddd55ddd04b9b4f485ed', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:16:46', '');
INSERT INTO `user` VALUES('dcabo', 'David Cabo', 'Madrid', 'david.cabo@gmail.com', '2e0b97b278aaadfdda6c1c5963212f28c9e59796', 'Ayudando a ONG Pro Bono Publico', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('elopez', 'Elvira LÃ³pez', 'Madrid', 'elvirilay@hotmail.com', '1d1d375939c74c8f755355f731c9eed3b4ee4297', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('emonivas', 'Esther MoÃ±ivas', 'Madrid', 'esther.monivas@gmail.com', '516d9ae4faac6f1425ef5fb0327d6bbb7948ea0b', 'Codirectora de la ONG AcciÃ³n C', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-07-05 01:55:04', '2011-07-13 19:39:38', '');
...
INSERT INTO `user` VALUES('eportillo', 'Esperanza Portillo', 'Madrid', 'portillo.esperanza@gmail.com', '549777e061b8dbadd683ca5293444f4095beaabf', 'Estudiante de master en gestiÃ³n cultural', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('evandellos', 'Emma VandellÃ³s ', 'Barcelona', 'emma.vandellos@esade.edu', 'f4ba05222b034f22339c7fb0ef299b925f02dcc8', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
...
INSERT INTO `user` VALUES('fcingolani', 'Francesco Cingolani', 'Madrid', 'fc@ecosistemaurbano.com', '2c6abab20f50218be59a8d2d62c100a9dc9d3a08', 'Arquitecto. Soy responsable de Urban Social Design Experience, un proyecto de networked learning promovido por la asociaciÃ³n Urban Social Design', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('fcoddou', 'Flavio Coddou', 'Barcelona', 'flaviocoddou@gmail.com', '3e61f6f52ca6136091ced69b745d79fd88e58f71', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:16:46', '');
INSERT INTO `user` VALUES('ffreitas', 'Flavia Freitas', 'Barcelona', 'flavia.frr@gmail.com', '023434d501234549299f47c90b37249b8544b7b5', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('fingrassia', 'Franco Ingrassia', 'Rosario', 'francoingrassia@gmail.com', '3e990f6eee34056154296953598b61d10d9c55f3', 'PsicÃ³logo. Involucrado en el proceso de constituciÃ³n de un Laboratorio del ProcomÃºn en la ciudad de Rosario (Argentina)', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('gbento', 'Gisele Bento', 'Barcelona', 'giselecultura@gmail.com', '1d0bee13a33f3ce2fcc7b8c83596c903c9d5a42d', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('gbezanilla', 'Gerardo Bezanilla', 'Madrid', 'gerardo@beusual.com', 'bda58288e44e1011c2cf94ebe4582662f9876497', 'DiseÃ±ador, Editor, Agente Cultural', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('gbossio', 'Gabriela Bossio', 'Madrid', 'gabrielabossio@gmail.com', '9e832ab9a645262404ca0e44b6616aca990b5fec', 'Directora Creativa y Gestora cultural de La casa del Ãrbol', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('goteo', 'Goteo Platoniq', 'mhkjghsdkj fkj sadkjf', 'goteo@doukeshi.org', 'b57a92c9a6501f4542d670f2a13e98287fc596ca', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'EconomÃ­a distribuida, Comunidades / Redes, InnovaciÃ³n social, TICs, CreaciÃ³n de redes, Prosumidores, Monedas complementarias, Redes sociales', 1, 75, '* BÃºsqueda y anÃ¡lisis de experiencias y herramientas que sirvan de modelo.\r\n* AsesorÃ­as tÃ©cnicas (seguridad en la red), legales y administrativas.\r\n* Crear las bases para desarrollar un prototipo.', 'platoniq', 'platoniq', 'facebook', 'google', 'platoniq', 3, '2011-05-20 01:44:15', '2011-07-14 23:15:25', '8eefe6e871cebe24248cc47d4b23d152goteo@doukeshi.org');
INSERT INTO `user` VALUES('gpedranti', 'Gabriela Pedranti', 'Barcelona', 'info@gabrielapedranti.com', '1d2a5c9df4290c12a5f5962e3d9fda38c85c072d', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:16:46', '');
...
INSERT INTO `user` VALUES('iromero', 'Imma Romero', 'Barcelona', 'ima_gina7@hotmail.com', 'ff5e6b74613597bfeaa59b91f9accc1d238cfefb', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('jlespina', 'JosÃ© Luis Espina', 'Barcelona', 'espinajl@gmail.com', '7bf9458b0c0549d310203f27c34f441ac074eb5a', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('jmatadero', 'Javi de Matadero', 'Madrid', 'javi@mataderomadrid.org', 'cb218e4b9fbbb89ec5804ec32ca1067e3679b311', 'Matadero', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('jmorer', 'Julia  Morer ', 'Madrid', 'julia.morer@gmail.com', '7b63000191f052ebb77324fe9940af29e9ad1765', 'EdiciÃ³n y DiseÃ±o de Proyectos Culturales', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:16:46', '');
...
INSERT INTO `user` VALUES('jnora', 'JuliÃ¡n Nora', 'Madrid', 'nora_julian@hotmail.com', '2eda3d6278dc18275918ea9ef18c0bdfe1c22a47', 'Ing. Simulacion ', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
...
INSERT INTO `user` VALUES('kventura', 'Kenia Ventura', 'Barcelona', 'dinkha@hotmail.com', '4e79b02993b50bddf2709ee5e764dfddc1c7661b', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('lcarretero', 'LucÃ­a Carretero', 'Barcelona', 'foto@luciacarretero.com', '29afdee54be1bbdf89242d5eb3cacf0c11b680f3', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('lfernandez', 'Laura FernÃ¡ndez', 'Madrid', 'laura@medialab-prado.es', '6823d091412f0850015e9a0e4983b48063e7a813', 'Responsable de programa cultural en Medialab-Prado', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:38', '');
INSERT INTO `user` VALUES('lstalling', 'Lars Stalling', 'Barcelona', 'larsst@gmail.com ', 'dbe4f8a3757235145f8ed0fde23e433fe5650872', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('maaban', 'Manuel Ãngel AbÃ¡n', 'Madrid', 'manuel.aban@gmail.com', 'd068342a85c48d2f95ea7661b2b0a5e77c56dc5c', 'Codirector de una ONG ', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('mduran', 'Magdalena Duran', 'Barcelona', 'magdaduran@yahoo.es', '5d5d2e7dfde93f13cc12abdacc10d7f2083f1c39', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('mgarcia', 'Miriam GarcÃ­a Sanz', 'Madrid', 'miriamgsanz@gmail.com', 'b982ca393b19498409bc749abefc585e14dc149f', 'Gestora cultural', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('mkekejian', 'Maral Kekejian ', 'Madrid', 'mkekejih@cajamadrid.es', '6bab1571a22fa60c8022a6dfcf397f97b0743279', 'Artes EscÃ©nicas LCE', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('mmikirdistan', 'Maral Mikirdistan', 'Barcelona', 'idensitat@idensitat.org', 'c63a6cb1c60e71b3a9f0d90a02ee392ff1a779ce', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('mpedroche', 'Mercedes Pedroche', 'Madrid', 'info@mercedespedroche.com', '570d6dc480ffbe1388e1bedce96e5a0e57e502b8', 'CoreÃ³grafa, bailarina', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('mramirez', 'Miguel RamÃ­rez', 'Barcelona', 'miquel.ramirez@gmail.com', 'f223dbfb37ae5507cdb7ced8d338e05a686bf25a', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('nescala', 'Nella Escala', 'Barcelona', 'nella.escala@gmail.com', '4ee7c6e03aaa371e7f3ee8dcaedd0d1f23a374da', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:16:46', '');
...
INSERT INTO `user` VALUES('pgonzalo', 'Pilar Gonzalo', 'Madrid', 'pilar.gonzalo@fulbrightmail.org', '2675dc74abf73a42520c10bcfad2cdca66a6f1c0', 'Museo Reina SofÃ­a', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:30:27', '');
INSERT INTO `user` VALUES('rcasado', 'Raul Casado', 'Barcelona', 'raul.casadogonzalez@gmail.com', '060d5b91ab484ba5bbd937c3cf23bd864ccba3d0', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('rparramon', 'Ramon Parramon', 'Barcelona', 'rparramon@acvic.org', '98de9c0d4367d83c6b18bac6e0010972261aa094', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('rsalas', 'Roberto Salas', 'Madrid', 'robers_alas@yahoo.es', '86a131eb71ceceddb26bc889895cf24ef96602e1', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
...
INSERT INTO `user` VALUES('sgrueso', 'StÃ©phane Grueso', 'Madrid', 'stephanegrueso@gmail.com', '2364b268a16831f859c5d17b7eda329fd39700a9', 'Cineasta documental', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:38', '');
INSERT INTO `user` VALUES('smeschede', 'SÃ¶ren Meschede', 'Madrid', 'soren@hablarenarte.com', '0b63ad3f4d744a320cf437f1ffecb4c24a74f74f', 'Gestor Cultural', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 20:30:28', '');
...
INSERT INTO `user` VALUES('tbadia', 'Tere Badia', 'Barcelona', 'tbadtod@gmail.com', '770b0c2422f238ff6662d2411900c6e57f130e22', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
INSERT INTO `user` VALUES('tguido', 'TomÃ¡s Guido', 'Madrid', 'tguido@transit.es', '325dce990aec945b7d843814911ae7811670dbee', 'Coordino la oficina en Madrid la empresa TrÃ nsit Projectes. www.transit.es', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user` VALUES('vtorre', 'VÃ­ctor Torre', 'Madrid', 'victortorrevaquero@yahoo.es', '09723c5bf0daf4c5c5b127ba269edc841327238c', 'Coordinador Teatro Sol y Tierra', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-14 10:11:24', '');
INSERT INTO `user` VALUES('yriquelme', 'Yolanda Riquelme ', 'Madrid', 'yolandariquel@hotmail.com', 'add40e3392132f436c194831fa81de1dd3b62962', '', '', 1, 0, '', '', '', '', NULL, '', 0, '2011-05-04 00:00:00', '2011-07-13 19:39:39', '');
...
INSERT INTO `user_personal` VALUES('goteo', 'Goteo Platoniq', NULL, '', NULL, '', '', '', '', '');
