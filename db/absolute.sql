...
--
-- Servidor: localhost
-- Tiempo de generación: 24-08-2011 a las 00:55:10
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=176 ;
...
INSERT INTO `invest` VALUES(175, 'goteo', 'tutorial-goteo', 'goteo@doukeshi.org', 2000, 1, NULL, 1, '2011-08-22', '2011-08-22', NULL, NULL, NULL, NULL, 'cash', 'goteo', NULL);
...
INSERT INTO `invest_address` VALUES(175, 'goteo', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `project` VALUES('goteo', 'Goteo', 1, 50, 'goteo', 'goteo', 340, 38, '2011-05-13', '2011-08-22', '2011-08-17', '0000-00-00', '0000-00-00', 'Susana Noguero', 'G63306914', '654321987', 'C/ Montealegre, 5', '8001', 'Barcelona', 'España', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '');
...
INSERT INTO `user` VALUES('root', 'Super administrador', '', 'julian_1302552287_per@gmail.com', 'f64dd0d8c9276d87c6d0ae24c5d12571c62ecf16', '', '', 1, 91, '', '', '', '', '', '', 3, '2011-07-20 20:40:14', '2011-08-22 16:47:09', '61aa85ea9169c68babfa5b8bdb44097bjulian_1302552287_per@gmail.com', 1);
