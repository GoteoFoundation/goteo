...
--
-- Servidor: localhost
-- Tiempo de generación: 26-11-2011 a las 16:20:10
...
CREATE TABLE `feed` (
  ...
  KEY `scope` (`scope`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log de eventos' AUTO_INCREMENT=289 ;
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=50 ;
...
INSERT INTO `invest` VALUES(25, 'goteo', 'tweetometro', 'goteo@doukeshi.org', 2000, 1, NULL, NULL, '2011-09-09', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
...
INSERT INTO `invest` VALUES(34, 'paypal', 'tweetometro', 'paypal_1315159211_per@gmail.com', 5000, 1, NULL, NULL, '2011-09-23', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
...
CREATE TABLE `mail` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contenido enviado por email para el -si no ves-' AUTO_INCREMENT=258 ;
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mensajes de usuarios en proyecto' AUTO_INCREMENT=158 ;
...
INSERT INTO `message` VALUES(156, 'diegobus', 'dinou-publicacio-irregular', NULL, '2011-11-09 08:45:47', 'Nueva colaboración: ', 1, 0);
...
INSERT INTO `purpose` VALUES('feed-project_finish', 'El proyecto %s ha <span class="red">completado la segunda ronda</span> obteniendo <span class="violet">%s &euro; (%s &#37;) de aportes sobre minimo</span>', 1, 'feed');
...
INSERT INTO `purpose` VALUES('header-about-side', 'Ideas fuerza', NULL, 'general');
...
INSERT INTO `purpose` VALUES('login-signin-openid', 'Accede con Open ID', NULL, 'login');
...
INSERT INTO `purpose` VALUES('overview-field-subtitle', 'Subtítulo', NULL, 'overview');
INSERT INTO `purpose` VALUES('overview-field-video', 'Video motivacional', NULL, 'overview');
...
INSERT INTO `purpose` VALUES('regular-fail_mark', 'Caducado...', NULL, 'widget');
...
INSERT INTO `purpose` VALUES('regular-header-glossary', 'Glosario de términos utilizados en Goteo', NULL, 'general');
...
INSERT INTO `purpose` VALUES('regular-keepiton_mark', 'Aún puedes seguir aportando', NULL, 'widget');
...
INSERT INTO `purpose` VALUES('tooltip-project-subtitle', 'Consejo para rellenar el subtítulo', NULL, 'overview');
...
INSERT INTO `purpose` VALUES('tooltip-project-video', 'Consejo video motivacional', NULL, 'overview');
...
INSERT INTO `support` VALUES(75, 'dinou-publicacio-irregular', 'Nueva colaboración', '', 'task', 156);
...
INSERT INTO `text` VALUES('main-banner-header', 'ca', '<h2 class="message">CATTT Red social para <span class="greenblue">cofinanciar y colaborar con</span><br /> proyectos creativos que fomentan el procomún<br /> ¿Tienes un proyecto con <span class="greenblue">adn abierto</span>?</h2><a href="/contact" class="button banner-button">Contáctanos</a>');
...
INSERT INTO `user` VALUES('aballesteros', 'Andrés Ballesteros', 'Cáceres', 'geopetro10@yahoo.es', '975b5f25e95d2afd7c22b50342ddffc5edba89a1', 'Abvmedioambiente', '', 1, 0, '', '', '', NULL, '', '', 1, '2011-05-04 00:00:00', '2011-11-11 09:15:37', '3685320c159d1692a065d5cdd333d32f¬geopetro10@yahoo.es', 0);
...
INSERT INTO `user` VALUES('aollero', 'Ana  Ollero', 'Cáceres', 'programaskreativos@gmail.com', 'a1d29ffc56898468565d89a267fa13b40d396278', 'Programas creativos', '', 1, 0, '', '', '', '', '', '', 0, '2011-05-04 00:00:00', '2011-11-01 13:59:08', '', 0);
...
INSERT INTO `user` VALUES('asdfas', 'asdfas', NULL, 'asdf@asdfsdaf.asd', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-11-11 09:16:52', '2011-11-11 09:17:07', '4c010b2f181deeb5f2c94912fa470291¬asdf@asdfsdaf.asd', 1);
...
INSERT INTO `user` VALUES('efoglia', 'Efraín Foglia', 'Barcelona', 'mexmafia@gmail.com', '9f1b78537a645a62e8404b774b0b69b8529e90c6', '', '', 1, 0, '', 'EfrainFoglia', '', NULL, '', '', 4, '0000-00-00 00:00:00', '2011-10-19 23:15:54', '', 0);
...
INSERT INTO `user` VALUES('jcanaves', 'jcanaves', '', 'jcanaves@doukeshi.org', '7c4a8d09ca3762af61e59520943dc26494f8941b', '', '', 1, NULL, '', NULL, NULL, NULL, NULL, NULL, 0, '2011-07-26 19:31:51', '2011-11-01 21:09:59', '83b6d443706802b159868bddb0f82fcb¬jcanaves@doukeshi.org', 0);
...
INSERT INTO `user` VALUES('olivier', 'Olivier Olivier Olivier Olivier Olivier Olivier Olivier Olivier Olivier Olivier Olivier Olivier', 'Palma de Mallorca', 'pepe_1303727124_per@gmail.com', '77cccf0d7a72ee0036f6f1a239d5c47ee8799014', 'Cofundador de Platoniq, organización catalana de innovadores sociales y desarrolladores de software', 'crowdfunding, copyleft, educación, innovación_social', 1, 119, '', 'platoniq', 'http://www.facebook.com/olivier.schulbaum', 'https://plus.google.com/116589329737135075630/', 'http://identi.ca/platoniq', 'http://www.linkedin.com/profile/view?id=98955103&locale=es_ES&trk=tab_pro', 0, '2011-11-09 13:04:09', '2011-11-09 13:04:09', 'bde8aad344ca0a7b6558a7b35b229f90', 0);
INSERT INTO `user` VALUES('paypal', 'Paypal Tester', 'aqui', 'paypal_1315159211_per@gmail.com', 'ab4d8d2a5f480a137067da17100271cd176607a1', 'Paypal Tester', 'paypal', 1, NULL, 'Paypal Tester', '', '', '', '', '', 5, '2011-10-17 10:13:50', '2011-10-17 10:13:50', 'c8812fc2560e9e5c786a4e2a64db5a15', 0);
