...
--
-- Servidor: localhost
-- Tiempo de generación: 04-10-2011 a las 11:29:34
...
CREATE TABLE `feed` (
  ...
  KEY `scope` (`scope`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log de eventos' AUTO_INCREMENT=122 ;
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=37 ;
...
INSERT INTO `invest` VALUES(30, 'goteo', 'fixie-per-tothom', 'goteo@doukeshi.org', 100, 1, NULL, NULL, '2011-09-20', NULL, NULL, 'PA-77V465081Y741603R', NULL, NULL, 'paypal', NULL, NULL);
...
INSERT INTO `invest` VALUES(36, 'goteo', 'tweetometro', 'goteo@doukeshi.org', 1000, 0, NULL, NULL, '2011-09-30', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
...
CREATE TABLE `mail` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contenido enviado por email para el -si no ves-' AUTO_INCREMENT=3 ;
...
INSERT INTO `mail` VALUES(2, 'hola@goteo.org', '<p>Hola <span class="message-highlight-red">Goteo</span>,</p>\r\n<p>Gracias por cofinanciar el proyecto <span class="message-highlight-blue"></span> con 1000 &euro;.</p>\r\n<p>Cuando termine la ronda se ejecutará el cargo en la cuenta especificada</p>\r\n<p>Has elegido las siguientes recompensas: Asesoría para futuros administradores de la aplicación, Instalación premium para una campaña concreta</p>\r\n<p>Muchas gracias !</p>\r\n<p>--<br />\r\nThe Goteo Mailer</p>');
...
INSERT INTO `project_account` VALUES('dinou-publicacio-irregular', NULL, 'projec_1314918267_per@gmail.com');
INSERT INTO `project_account` VALUES('fixie-per-tothom', NULL, 'projec_1314918267_per@gmail.com');
...
CREATE TABLE `template` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Plantillas emails automáticos' AUTO_INCREMENT=11 ;
