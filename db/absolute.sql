...
--
-- Servidor: localhost
-- Tiempo de generación: 11-10-2011 a las 17:54:54
...
CREATE TABLE `feed` (
  ...
  KEY `scope` (`scope`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log de eventos' AUTO_INCREMENT=145 ;
...
CREATE TABLE `mail` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contenido enviado por email para el -si no ves-' AUTO_INCREMENT=12 ;
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mensajes de usuarios en proyecto' AUTO_INCREMENT=156 ;
...
INSERT INTO `message` VALUES(155, 'diegobus', 'fixie-per-tothom', NULL, '2011-10-09 22:10:26', 'Espacio taller: Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 1, 0);
...
INSERT INTO `support` VALUES(23, 'fixie-per-tothom', 'Espacio taller', 'Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 'lend', 155);
...
CREATE TABLE `template` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Plantillas emails automáticos' AUTO_INCREMENT=26 ;
...
INSERT INTO `template` VALUES(20, 'Notificación al autor proyecto supera primera ronda', 'Mensaje al autor de un proyecto cuando este pasa a segunda ronda', 'El proyecto %PROJECTNAME% lleva 20 días en campaña', '<p>Hola <span class="message-highlight-red">%USERNAME%</span>,</p>\r\n<p>enhorabuena! Tu proyecto <span class="message-highlight-blue">%PROJECTNAME%</span> ha pasado a segunda ronda pero esto no se acaba aquí.</p>\r\n<p>Te recordamos que puedes encontrar el widget para publicitar tu proyecto en tu <span class="message-highlight-blue"><a href="%WIDGETURL%">Dashboard</a></span>.</p>\r\n<p>Mucha suerte !</p>\r\n<p>--<br />\r\nThe Goteo Mailer</p>');
