...
--
-- Servidor: localhost
-- Tiempo de generación: 25-09-2011 a las 09:22:44
...
CREATE TABLE `feed` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Log de eventos' AUTO_INCREMENT=81 ;
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=35 ;
...
INSERT INTO `invest` VALUES(30, 'goteo', 'fixie-per-tothom', 'goteo@doukeshi.org', 100, 2, NULL, NULL, '2011-09-20', NULL, NULL, 'PA-77V465081Y741603R', NULL, NULL, 'paypal', NULL, NULL);
...
INSERT INTO `invest` VALUES(34, 'paypal', 'tweetometro', 'paypal_1315159211_per@gmail.com', 5000, 0, NULL, NULL, '2011-09-23', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
...
INSERT INTO `invest_address` VALUES(30, 'goteo', 'C/ Montealegre, 5', '8001', 'Barcelona', 'España', 'Susana Noguero', 'G63306914');
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Mensajes de usuarios en proyecto' AUTO_INCREMENT=155 ;
...
INSERT INTO `message` VALUES(146, 'diegobus', 'dinou-publicacio-irregular', NULL, '2011-09-20 19:20:16', 'Nueva colaboración: ', 1, 0);
...
INSERT INTO `message` VALUES(149, 'diegobus', 'fixie-per-tothom', NULL, '2011-09-23 11:45:23', 'Espacio taller: Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 1, 0);
...
INSERT INTO `message` VALUES(152, 'goteo', 'goteo', NULL, '2011-09-24 18:37:13', 'Nueva colaboración: asdf asdf', 1, 0);
...
INSERT INTO `purpose` VALUES('dashboard-password-recover-advice', 'Estás recuperando tu contraseña, recuerda poner el nombre de usuario en el campo "contraseña actual" para cambiarla', NULL, 'dashboard');
...
INSERT INTO `purpose` VALUES('dashboard-project-blog-wrongstatus', 'Lo sentimos, aún no se pueden publicar actualizaciones en este proyecto...', NULL, 'dashboard');
...
INSERT INTO `purpose` VALUES('feed-new_project', '<span class="red">Nuevo proyecto en Goteo</span>, desde ahora tienes 40 días para apoyar este proyecto', 1, 'feed');
...
INSERT INTO `purpose` VALUES('feed-new_update', 'Ha publicado un nuevo post en %s sobre el proyecto %s, con el título "%s"', 1, 'feed');
INSERT INTO `purpose` VALUES('feed-new_user', 'Nuevo usuario en Goteo %s', 1, 'feed');
INSERT INTO `purpose` VALUES('feed-project_fail', 'El proyecto %s ha <span class="red">caducado sin éxito</span> obteniendo <span class="violet">%s &euro; (%s &#37;) de aportes sobre minimo</span>', 1, 'feed');
INSERT INTO `purpose` VALUES('feed-project_goon', 'El proyecto %s <span class="red">continua en campaña</span> en segunda ronda obteniendo <span class="violet">%s &euro; (%s &#37;) de aportes sobre minimo</span>', 1, 'feed');
...
INSERT INTO `purpose` VALUES('social-account-facebook', 'Página Goteo Facebook', NULL, 'social');
INSERT INTO `purpose` VALUES('social-account-google', 'Página Goteo Google', NULL, 'social');
...
INSERT INTO `purpose` VALUES('tooltip-project-supports', 'En Goteo los proyectos pueden recibir otro tipo de ayudas además de aportaciones monetarias. Hay gente que a lo mejor no pueda ayudar económicamente pero sí con su talento, tiempo, energía, etc.', NULL, 'supports');
...
INSERT INTO `purpose` VALUES('user-login-required', 'Debes iniciar sesión para poder hacer comentarios, cofinanciar y hacer aportaciones o bien crear un proyecto.', NULL, 'general');
...
INSERT INTO `reward` VALUES(180, 'dinou-publicacio-irregular', 'Descarga PDF del periódico ', 'Descarga PDF del periódico para reproducción parcial o total', 'social', 'file', '', 'ccbync', 0, 0, 0);
...
CREATE TABLE `support` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Colaboraciones' AUTO_INCREMENT=108 ;
...
INSERT INTO `support` VALUES(23, 'fixie-per-tothom', 'Espacio taller', 'Donec ultrices libero in est tincidunt placerat tempor mi mattis. Vestibulum at aliquam lacus. Suspendisse condimentum metus vel arcu faucibus id volutpat arcu ultricies. Nulla pellentesque mi at dolor accumsan accumsan. ', 'lend', 149);
...
INSERT INTO `support` VALUES(75, 'dinou-publicacio-irregular', 'Nueva colaboración', '', 'task', 146);
...
CREATE TABLE `template` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Plantillas emails automáticos' AUTO_INCREMENT=10 ;
...
INSERT INTO `template` VALUES(9, 'Darse de baja', 'Plantilla para el mensaje al solicitar la baja', 'Solicitud de baja en Goteo', 'Hola %USERNAME%:\r\n\r\nHemos recibido una solicitud para dar de baja tu cuenta de usuario en http://goteo.org/\r\n\r\nPara completar el proceso de baja accede el siguiente enlace:\r\n\r\n%URL%\r\n\r\nSi no puedes hacer click, cópialo y pégalo en el navegador.\r\n\r\n(En caso de que no hayas has solicitado esta baja, uhm... ignora este mensaje).\r\n\r\n--\r\n\r\nThe Goteo Mailer');
...
INSERT INTO `user` VALUES('abenitez', 'Alba Benitez', 'Cáceres', 'albabenitez1983@gmail.com', 'ccb39ea899a2dbc60867cfec2495ffcbfb2eb42d', 'Autónoma-Sector cultural', '', 1, 0, '', '', '', '', '', '', 2, '2011-05-04 00:00:00', '2011-09-22 17:28:27', '25ac8112bfd7d55eb295f2e7f42c9a72¬albabenitez1983@gmail.com', 0);
...
INSERT INTO `user` VALUES('afolguera', 'Antonia Folguera', 'Barcelona', 'antonia@riereta.net', '232083fdb8d80ac58b79ab55b75d302e54b5038b', '', '', 1, 0, '', '', '', NULL, '', '', 1, '2011-05-04 00:00:00', '2011-09-22 17:24:01', '2bd4cc0ddd8c303b046977e3b6ca90bb¬antonia@riereta.net', 0);
...
INSERT INTO `user` VALUES('amartinez', 'Alfonso Martínez', 'Barcelona', 'martinezrubioo@gmail.com', 'b9ee4c65c2de3f007eef8e0cd9e39d2ef49aa17b', '', '', 1, 0, '', '', '', '', '', '', 0, '2011-05-04 00:00:00', '2011-09-21 17:01:34', '', 0);
...
INSERT INTO `user` VALUES('jcanaves', 'jcanaves', '', 'jcanaves@doukeshi.org', '7c4a8d09ca3762af61e59520943dc26494f8941b', '', '', 1, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, '2011-07-26 19:31:51', '2011-09-22 17:23:33', '83b6d443706802b159868bddb0f82fcb¬jcanaves@doukeshi.org', 0);
...
INSERT INTO `user` VALUES('paypal', 'Paypal Tester', 'aqui', 'paypal_1315159211_per@gmail.com', 'ab4d8d2a5f480a137067da17100271cd176607a1', '', '', 1, NULL, '', '', '', '', '', '', 0, '2011-09-04 20:02:46', '2011-09-23 11:45:24', 'c8812fc2560e9e5c786a4e2a64db5a15', 1);
