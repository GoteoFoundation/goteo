...
--
-- Servidor: localhost
-- Tiempo de generación: 27-09-2011 a las 20:16:05
...
CREATE TABLE `mail` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Contenido enviado por email para el -si no ves-' AUTO_INCREMENT=2 ;

--
-- Volcar la base de datos para la tabla `mail`
--

INSERT INTO `mail` VALUES(1, 'hola@goteo.org', 'Hola Goteo, <br />\r\n<br />\r\nÉste es un mensaje enviado por Goteo desde Goteo:<br />\r\n<br />\r\nsadf asdf adf <br />\r\n<br />\r\nTe recordamos que puedes ver la gente con la que estás en contacto desde Goteo en tu perfil:<br />\r\n<br />\r\nhttp://devgoteo.org/user/profile/goteo/sharemates<br />\r\n<br />\r\n--<br />\r\n<br />\r\nThe Goteo Mailer');
...
INSERT INTO `purpose` VALUES('mailer-baja', 'No quieres recibir más comunicaciones de GOTEO.ORG? puede darse de baja <a href="%s">AQUÍ</a>', 1, 'mailer');
INSERT INTO `purpose` VALUES('mailer-disclaimer', '* GOTEO es una plataforma digital para constituir una red social de producción, microfinanciación y distribución de recursos para el sector creativo, para el desarrollo de proyectos sociales, culturales, educativos, tecnológicos...  que contribuyan al fortalecimiento del dominio público.', NULL, 'mailer');
INSERT INTO `purpose` VALUES('mailer-sinoves', 'Si no puedes ver este mensaje da click  <a href="%s"> aquí</a>', 1, 'mailer');
...
INSERT INTO `purpose` VALUES('recover-email-sended', 'Te hemos enviado un email para recuperar la contraseña de tu cuenta. Verifica también la carpeta de correo no deseado o spam.', NULL, 'register');
...
INSERT INTO `user` VALUES('paypal', 'Paypal Tester', 'aqui', 'paypal_1315159211_per@gmail.com', 'ab4d8d2a5f480a137067da17100271cd176607a1', '', '', 1, NULL, '', '', '', '', '', '', 5, '2011-09-04 20:02:46', '2011-09-27 09:12:25', 'c8812fc2560e9e5c786a4e2a64db5a15', 1);
