...
--
-- Servidor: localhost
-- Tiempo de generación: 17-08-2011 a las 21:50:35
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=174 ;
...
INSERT INTO `invest` VALUES(171, 'goteo', 'tweetometro', 'goteo@doukeshi.org', 1000, 0, 1, NULL, '2011-08-14', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(172, 'goteo', 'tweetometro', 'goteo@doukeshi.org', 10, 0, NULL, 1, '2011-08-17', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
INSERT INTO `invest` VALUES(173, 'goteo', 'tutorial-goteo', 'goteo@doukeshi.org', 26, 0, NULL, 1, '2011-08-17', NULL, NULL, NULL, NULL, NULL, 'cash', NULL, NULL);
...
INSERT INTO `post` VALUES(34, 1, 'asdf sadf', 'asdf sadf', '', NULL, '2011-08-17', 1, 0, 1, 0, 1);
...
INSERT INTO `project` VALUES('goteo', 'Goteo', 3, 50, 'goteo', 'goteo', 340, 40, '2011-05-13', '2011-08-16', '2011-08-17', '0000-00-00', '0000-00-00', 'Susana Noguero', 'G63306914', '654321987', 'C/ Montealegre, 5', '8001', 'Barcelona', 'España', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '');
...
INSERT INTO `purpose` VALUES('error-register-username', 'El nombre de usuario es obligatorio.', NULL, 'register');
...
CREATE TABLE `sponsor` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Patrocinadores' AUTO_INCREMENT=5 ;
...
INSERT INTO `sponsor` VALUES(4, 'asd', 'sadf', 121, 3);
...
CREATE TABLE `template` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Plantillas emails automáticos' AUTO_INCREMENT=8 ;
...
INSERT INTO `template` VALUES(6, 'Recuperar contraseña', 'Plantilla para el mensaje al solicitar la recuperación de cotnraseña', 'Su petición de recuperación de contraseña en Goteo', 'Hola <strong>%USERNAME%</strong>:\r\n\r\nHemos recibido una petición para recuperar la contraseña de tu cuenta de usuario en Goteo.org\r\n\r\nPara acceder a tu cuenta y cambiar la contraseña (utilice su nombre de usuario como contraseña actual), utiliza el siguiente enlace. Si no puedes hacer click, copialo y pegalo en el navegador.\r\n\r\n%RECOVERURL%\r\n\r\nRecuerda que tu login es <strong>%USERID%</strong>, úsalo como contraseña actual para cambiar la contraseña.\r\n\r\nSi no has solicitado esta recuperación de contraseña, ignora este mensaje.\r\n\r\n--\r\nThe Happy Goteo Mailer');
