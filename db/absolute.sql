...
--
-- Servidor: localhost
-- Tiempo de generación: 14-08-2011 a las 13:15:20
...
INSERT INTO `image` VALUES(121, 'speed-up.jpg', 'image/jpeg', 36069);
...
CREATE TABLE `invest` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Aportes monetarios a proyectos' AUTO_INCREMENT=172 ;
...
INSERT INTO `invest_address` VALUES(171, 'goteo', 'C/ Montealegre, 5', '8001', 'Barcelona', 'España');
...
INSERT INTO `project` VALUES('goteo', 'Goteo', 1, 50, 'goteo', 'goteo', 340, 0, '2011-05-13', '2011-08-14', '0000-00-00', '0000-00-00', '0000-00-00', 'Susana Noguero', 'G63306914', '654321987', 'C/ Montealegre, 5', '8001', 'Barcelona', 'España', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '');
...
INSERT INTO `reward` VALUES(232, 'goteo', 'Nuevo retorno colectivo', NULL, 'social', '', NULL, '', NULL, NULL, 0);
...
INSERT INTO `template` VALUES(2, 'Mensaje para cofinanciadeores', 'Plantilla del mensaje masivo a cofinanciadores desde dashboard - gestión de retornos', 'Mensaje del proyecto que cofinancias: %PROJECTNAME%', 'Hola <strong>%NAME%</strong>, este es un mensaje enviado desde Goteo por el productor del proyecto %PROJECTNAME%\r\n\r\n%MESSAGE%\r\n\r\nPuedes ver el proyecto en %PROJECTURL%\r\n\r\n--\r\nThe Happy Goteo Mailer');
...
INSERT INTO `template` VALUES(5, 'Confirmación de registro', 'Plantilla del mensaje de confirmación de registro', 'Confirmación de usuario en Goteo', 'Hola <strong>%USERNAME%</strong>:\r\n\r\nGracias por registrarte en Goteo.org, tu cuenta ha sido creada con éxito.\r\n\r\nPara activar confirmar tu dirección de correo electrónico y completar el registro, clica en el siguiente enlace (o copia el enlace en la barra de dirección del navegador):\r\n\r\n%ACTIVATEURL%\r\n\r\nRecuerda que tu nombre de usuario es <strong>%USERID%</strong>, una vez se active tu cuenta podrás acceder y disfrutar de los servicios que ofrecemos.\r\n\r\nSi no has solicitado este registro, ignora este mensaje.\r\n\r\n--\r\nThe Happy Goteo Mailer');
