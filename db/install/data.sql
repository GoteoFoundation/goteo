...
INSERT INTO `page`(`id`,`name`,`description`,`type`,`url`,`content`) VALUES ('big-error','BIG error','Internal server error and so on','html','/about/fail',NULL);
...
INSERT INTO `page`(`id`,`name`,`description`,`type`,`url`,`content`) VALUES ('error','Standard error','Url dont match controller','html','/about/error',NULL);
