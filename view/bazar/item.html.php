...
$item_twitter_url = 'http://twitter.com/home?status=' . urlencode($item->title . ': ' . $item_url);
$item_facebook_url = 'http://facebook.com/sharer.php?u=' . urlencode($item_url) . '&t=' . urlencode($item->title);
...
<article class="activable">
	...
	<p class="desc"><?php echo $item->title; ?><br /><span class="by"><?php echo Text::get('regular-by').' '.$item->project->name ?></span></p>
	<nav>    
