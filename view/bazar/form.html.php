...
/*
// si es de convocatoria no permitimos paypal
...
<article id="formulario">
	...
	<form method="post" action="/bazaar/pay/<?php echo $item->id; ?>" onsubmit="<?php echo (isset($_SESSION['user'])) ? 'return valida();' : 'return validar();' ?>" >
		...
		<div id="sendto" class="formfields alone">
			<label><input type="checkbox" onchange="showContent();" id="check" name="regalo" /><?php echo Text::get('invest-address-friend-field') ?></label>
		</div>
		...
		<div id="fields-investor" class="formfields">
			<div class="field">
				...
				<input type="text" onblur="vfield('name');" id="name" name="name" value="<?php echo $_SESSION['bazar']['name']; ?>" />
			</div>
			...
			<div class="field">
				...
				<input type="text" onblur="valremail();" id="remail" name="remail" value="<?php echo $_SESSION['bazar']['remail']; ?>" />
			</div>
		</div>
		<?php endif; ?>
		...
		<div id="fields-address" class="formfields">
			<div class="field">
				...
				<input type="text" onblur="vfield('address');" id="address" name="address" value="<?php echo $_SESSION['bazar']['address']; ?>" />
			</div>

			<div class="field">
				<label for="location"><?php echo Text::get('invest-address-location-field') ?> *</label><span class="error" id="locationi"></span><br />
				<input type="text" onblur="vfield('location');" id="location" name="location" value="<?php echo $_SESSION['bazar']['location']; ?>" />
			</div>

			<div class="field">
				<label for="country"><?php echo Text::get('invest-address-country-field') ?> *</label><span class="error" id="countryi"></span><br />
				<input type="text" onblur="vfield('country');" id="country" name="country" value="<?php echo $_SESSION['bazar']['country']; ?>" />
			</div>
		...
		<div id="anonm" class="formfields alone">
			<label for="anonymous"><input type="checkbox" id="anonymous" name="anonymous" /><?php echo Text::get('invest-anonymous') ?></label><br />
		</div>
