...
?>
<a href="/admin/bazar/add" class="button">Nuevo Elemento</a>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width:105px;text-align: left;"><?php if (isset($promo->img)) : ?><img src="<?php echo SITE_URL.'/data/images/'.$promo->img->name; ?>" alt="image"  style="width:100x;height:100px;"/><?php endif; ?></td>
