...
<div class="widget">
    ...
    <p>Si todo está bien pulsar el botón para activar los envíos automáticos.<br /> <a href="/admin/newsletter/activate" class="button weak" onclick="return confirm('Se comenzará a enviar automáticamente')">ACTIVAR!</a></p>
