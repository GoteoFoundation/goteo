        ...
        <tbody>
            ...
            <tr>
                <td colspan="7">
                    ...
                    <?php if ($project->status == 3) : ?><a href="<?php echo "/admin/projects/noinvest/{$project->id}"; ?>" onclick="return confirm('No se podrá aportar más l proyecto pero este sigue técnicamente en campaña hasta final de ronda, ok?');">[Cortar el grifo]</a><?php endif; ?>
                </td>
            </tr>
            <tr>
                <td colspan="5">
