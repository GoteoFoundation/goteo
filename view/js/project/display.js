...
GOTEO.getDates = function(dates) {
    ...
    if (!dates.passed && !dates.success && !dates.closed) {
        // Active project
        GOTEO.dates.deadline = d3.time.day.offset(GOTEO.dates.start_date, PRIMERA_RONDA);
        ...
        GOTEO.dates.deadline = d3.time.day.offset(GOTEO.dates.start_date, SEGUNDA_RONDA);
    ...
    GOTEO.dates.total_days = (dates.passed) ? SEGUNDA_RONDA : PRIMERA_RONDA;
