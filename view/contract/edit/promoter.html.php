...
echo new SuperForm(array(
    ...
    'elements'      => array(
        ...
        'contract_entity-radioset' => array(
            ...
            'hint'      => Text::get('tooltip-contract-contract_entity'),
            'children'  => array(
                'contract_entity-person' =>  array(
                    ...
                    'checked' => !$contract->contract_entity ? true : false,
                    'children' => array(
        ...
        'contract' => array(
            ...
            'hint'      => Text::get('tooltip-contract-contract_data'),
            'children'  => array(
                'contract_name' => array(
                    'type'      => 'textbox',
                    'class'     => 'inline',
                    ...
                    'hint'      => Text::get('tooltip-contract-contract_name'),
                ...
                'contract_nif' => array(
                    ...
                    'size'      => 9,
                    'hint'      => Text::get('tooltip-contract-contract_nif'),
                ...
                'phone' => array(
                    ...
                    'dize'      => 15,
                    'hint'      => Text::get('tooltip-contract-phone'),
                ...
                'contract_email' => array(
                    ...
                    'size'      => 9,
                    'hint'      => Text::get('tooltip-contract-contract_email'),
                ...
                'contract_birthdate'  => array(
                    ...
                    'hint'      => Text::get('tooltip-contract-contract_birthdate'),
                    ...
                    'value'     => $contract->contract_birthdate
                )
        ...
        'main_address' => array(
            ...
            'hint'      => Text::get('tooltip-contract-main_address'),
            'children'  => array(
                'address' => array(
                    'type'      => 'textbox',
                    'class'     => 'inline',
