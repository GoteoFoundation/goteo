...
<div style="width: 600px; background-color: #ffffff;padding: 20px 10px 20px 20px;margin-top: 20px;">
    ...
    <div style="color: #38b5b1;font-weight: bold;text-transform: uppercase;font-size: 16px;">
        ...
        <a href="<?php echo $url ?>" style="text-decoration:none;color: #38b5b1;font-size: 14px;font-weight: normal;font-style: normal;text-transform: none; padding-top:5px;"><?php echo $promote->promo_text; ?></a>
    </div>
