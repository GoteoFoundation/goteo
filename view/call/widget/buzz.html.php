<div id="side">
    <p><?php echo Text::get('call-header-buzz') ?></p>
...
<div style="border-bottom: 1px solid grey; display: block;">
    <div style="float: left; margin-right: 5px;">
        <a href="https://twitter.com/MagmaCultura" target="_blank">
            <img src="http://a0.twimg.com/profile_images/2602026186/r2vhs8x0azj4zrve1tv2_normal.jpeg" alt="MagmaCultura" title="MagmaCultura">
        </a>
    </div>
    <div>
