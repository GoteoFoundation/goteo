                    ...
                    <ol class="fields">
                        ...
                        <li class="field" id="field-contract_name">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="contract_name" value="<?php if (isset($project->contract_name)) echo htmlspecialchars($project->contract_name) ?>" /></div>
                            </div>
                        </li>
                        ...
                        <li class="field" id="field-contract_surname">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="contract_surname" value="<?php if (isset($project->contract_surname)) echo htmlspecialchars($project->contract_surname) ?>" /></div>
                            </div>
                        </li>
                         ...
                         <li class="field" id="field-contract_nif">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="contract_nif" value="<?php if (isset($project->contract_nif)) echo htmlspecialchars($project->contract_nif) ?>" /></div>
                            </div>
                        </li>
                        ...
                        <li class="field" id="field-contract_email">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="contract_email" value="<?php if (isset($project->contract_email)) echo htmlspecialchars($project->contract_email) ?>" /></div>
                            </div>
                        </li>
                        ...
                        <li class="field" id="field-phone">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="phone" value="<?php if (isset($project->phone)) echo htmlspecialchars($project->phone) ?>" /></div>
                            </div>
                        </li>
                        ...
                        <li class="field" id="field-address">
                            <div class="field">
                                ...
                                <div class="elements"><textarea name="address"><?php if (isset($project->address)) echo htmlspecialchars($project->address) ?></textarea></div>
                            </div>
                        </li>
                        ...
                        <li class="field" id="field-zipcode">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="zipcode" value="<?php if (isset($project->zipcode)) echo htmlspecialchars($project->zipcode) ?>" /></div>
                            </div>
                        </li>
                        ...
                        <li class="field" id="field-location">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="location" value="<?php if (isset($project->location)) echo htmlspecialchars($project->location) ?>" /></div>
                            </div>
                        </li>
                        ...
                        <li class="field" id="field-country">
                            <div class="field">
                                ...
                                <div class="elements"><input class="main" type="text" name="country" value="<?php if (isset($project->country)) echo htmlspecialchars($project->country) ?>" /></div>
                            </div>
                        </li>
