...
<div class="widget project-share">    
	<div class="left">
        ...
        <ul>
            <li class="twitter"><a target="_blank" href="<?php echo htmlspecialchars($twitter_url) ?>"><?php echo Text::get('regular-twitter'); ?></a></li>
            <li class="facebook"><a target="_blank" href="<?php echo htmlspecialchars($facebook_url) ?>"><?php echo Text::get('regular-facebook'); ?></a></li>
