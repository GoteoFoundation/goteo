    ...
    <div class="individual">
        ...
        <li class="<?php echo $individual->icon ?>">
            ...
            <p><?php echo htmlspecialchars($individual->description)?></p>
                ...
                <?php if (!$individual->none) : ?><a href="/project/<?php echo $project->id ?>/invest?amount=<?php echo $individual->amount ?>" class="button violet" style="margin-left: 30px;">Get it!</a><?php endif; ?>
                </div>
        </li>
        <?php endforeach ?>
        </ul>
