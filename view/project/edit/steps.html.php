...
<div id="project-steps">
            ...
            <fieldset>
                ...
                <div class="steps">
                    ...
                    <span class="step first-off off<?php if ($this['step'] === 'userProfile') echo ' active' ?>">
                    ...
                    <span class="step off-off off<?php if ($this['step'] === 'userPersonal') echo ' active' ?>">
                    ...
                    <fieldset style="display: inline">
                        ...
                        <span class="step off-on<?php if ($this['step'] === 'overview') echo ' active' ?>">
                        ...
                        <span class="step on-on<?php if ($this['step'] === 'costs') echo ' active' ?>">
                        ...
                        <span class="step on-on<?php if ($this['step'] === 'rewards') echo ' active' ?>">
                        ...
                        <span class="step on-off<?php if ($this['step'] === 'supports') echo ' active' ?>">
                    ...
                    <span class="step off-last off<?php if ($this['step'] === 'preview') echo ' active' ?>">
