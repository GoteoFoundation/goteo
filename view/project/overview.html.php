...
include 'view/prologue.html.php';
            ...
            <div class="superform aqua">
                ...
                <?php echo new View('view/project/guide.html.php', array('text' => $this['steps'][$this['step']]['guide'])) ?>
                    ...
                    if ($this['nodesign'] == true) :
                        ...
                        ?>
            <?php if (!empty($project->errors['overview'])) :
                echo '<p>';
                foreach ($project->errors['overview'] as $campo=>$error) : ?>
    ...
    <dl>
        ...
        <dd><?php foreach ($categories as $Id => $Val) : ?>
            <label><input type="checkbox" id="categories" name="categories[]" value="<?php echo $Id; ?>" <?php if (in_array($Id, $project->categories)) echo ' checked="checked"'; ?> /><?php echo $Val; ?></label>
            <?php endforeach; ?>
        </dd>
        ...
        <span><?php echo Text::get('tooltip project project_location'); ?> (Si es solo online poner "online")</span><br />
                ...
                <div class="buttons">
                    <input type="hidden" name="step" value="overview" /><!-- por ahora no me escapo de tener que poner esto... -->
