...
//            $debug = (isset($_GET['debug']) && $_GET['debug'] == 'debug') ? true : false;
         ...
         */
        private function cron_warn_no_paypal_account($project) {
         ...
         */
        private function cron_feed_project_finishing($project) {
         ...
         */
        private function cron_project_has_failed($project, $per_amount) {
         ...
         */
        private function cron_project_has_finished_first_round($project, $per_amount) {
            echo $project->name . ': ha recaudado ' . $project->amount . ', '.$per_amount.'% de ' . $project->mincost . '/' . $project->maxcost . '<br />';
         ...
         */
        private function cron_project_has_finished_second_round($project, $per_amount) {
            echo $project->name . ': ha recaudado ' . $project->amount . ', '.$per_amount.'% de ' . $project->mincost . '/' . $project->maxcost . '<br />';
         ...
         */
        private function cron_cancel_payment($invest, $project, $userData) {
         ...
         */
        private function cron_execute_payment($invest, $project, $userData, $projectAccount) {
