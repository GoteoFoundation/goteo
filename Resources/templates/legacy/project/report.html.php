...
<div class="widget report">
    <h3 class="title" style="text-transform: none;">Informe de financiación del proyecto <?php echo $cName; ?><br /><span style="color:#20B2B3;"><?php echo $this->ee($project->name) ?></span></h3>
