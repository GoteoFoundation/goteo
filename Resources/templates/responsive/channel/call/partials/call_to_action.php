      ...
      <div class="row">
        ...
        <?php if ($this->channel->call_inscription_open): ?>
            ...
            <div class="create-project">
              ...
              <div class="info">
                ...
                <div class="col-button">
                    <a href="/project/create" class="btn btn-transparent"><i class="icon icon-plus icon-2x"></i><?= $this->text('regular-create') ?></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-sm-12 join-call">
            <div class="join-call">
              <img class="img-responsive" src="/assets/img/channel/call/training.png" >
              <div class="info">
                <div class="title">
                ...
                <div class="col-button">
                    <a href="/channel/crowdcoop/faq/training" class="btn btn-yellow"><i class="icon icon-plus icon-2x"></i><?= $this->text('landing-more-info') ?></a>
                </div>
              </div>
            </div>
          </div>
