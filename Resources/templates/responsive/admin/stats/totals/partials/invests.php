<div class="row">
    <ul class="row list-unstyled d3-chart loading discrete-values" data-source="/api/charts/totals/invests/raised?<?= $this->query ?>" data-interval="40" data-flash-time="15" data-delay="50">
        ...
        <li class="col-xs-2 col-xxs-4" data-property="raised.global.last_year.amount_formatted" data-title="<?= $this->text('admin-invest-raised-amount-last_year') ?>"></li>
    </ul>
    <ul class="row list-unstyled d3-chart loading discrete-values" data-source="/api/charts/totals/invests/commissions?<?= $this->query ?>" data-interval="40" data-interval-delay="10" data-flash-time="15" data-delay="50">
    ...
    <ul class="row list-unstyled d3-chart loading discrete-values" data-source="/api/charts/totals/invests/commissions/paypal?<?= $this->query ?>" data-interval="40" data-interval-delay="20" data-flash-time="15" data-delay="50">
    ...
    <ul class="row list-unstyled d3-chart loading discrete-values" data-source="/api/charts/totals/invests/commissions/tpv?<?= $this->query ?>" data-interval="40" data-interval-delay="20" data-flash-time="15" data-delay="50">
    ...
    <?php endif ?>
    <ul class="row list-unstyled d3-chart loading discrete-values" data-source="/api/charts/totals/invests/fees?<?= $this->query ?>" data-interval="40" data-interval-delay="30" data-flash-time="15" data-delay="50">
