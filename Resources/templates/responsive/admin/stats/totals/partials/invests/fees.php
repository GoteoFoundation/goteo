...
<div class="d3-chart loading discrete-values" data-source="/api/charts/totals/invests/<?= "$target/$id/$slot1" ?>?<?= $query ?>" data-interval="40" data-flash-time="15" data-delay="50">
    ...
    <ul class="row list-unstyled">
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1" ?>.subtotal_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1" ?>.subtotal_diff_formatted" data-title="<?= $this->text('admin-' . $target) . ': ' .$this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1" ?>.vat_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1" ?>.vat_diff_formatted" data-title="<?= $this->text('admin-vat') . ': ' . $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
    ...
    <ul class="row list-unstyled">
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1" ?>.user_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1" ?>.user_diff_formatted" data-title="<?= $this->text('admin-user-fee') . ': ' .$this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1" ?>.call_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1" ?>.call_diff_formatted" data-title="<?= $this->text('admin-call-fee') . ': ' . $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1" ?>.matcher_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1" ?>.matcher_diff_formatted" data-title="<?= $this->text('admin-matcher-fee') . ': ' . $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
