...
<?php foreach(['raised', 'active'] as $type): ?>
    ...
    <ul class="row list-unstyled">
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1.$type" ?>_matchfunding_amount_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1.$type" ?>_matchfunding_amount_diff_formatted" data-title="<?= $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1.$type" ?>_users_amount_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1.$type" ?>_users_amount_diff_formatted" data-title="<?= $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
    ...
    <ul class="row list-unstyled">
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1.$type" ?>_from_matchfunding_amount_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1.$type" ?>_from_matchfunding_amount_diff_formatted" data-title="<?= $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1.$type" ?>_from_users_amount_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1.$type" ?>_from_users_amount_diff_formatted" data-title="<?= $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
        ...
        <li class="col-xs-2 col-xxs-4" data-property="<?= "$target.$id.$slot1.$type" ?>_from_matcher_amount_<?= $slot2 ?>_gain_formatted" data-tooltip="<?= "$target.$id.$slot1.$type" ?>_from_matcher_amount_diff_formatted" data-title="<?= $this->text('admin-diff') ?>"></li>
        <?php endif ?>
        <?php if($slot3): ?>
