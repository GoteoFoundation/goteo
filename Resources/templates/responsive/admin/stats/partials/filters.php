...
<div class="row table-row">
    ...
    <div class="form-group col-xs-6 col-sm-5">
        ...
        <div class="input-group date">
            <input type="date" class="form-control -datepicker-full" id="filter-from" autocomplete="off" autocorrect="off" autocapitalize="off" name="from" value="<?= $this->filters['from'] ?>">
    ...
    <div class="form-group col-xs-6 col-sm-5">
        ...
        <div class="input-group date">
            <input type="date" class="form-control -datepicker-full" id="filter-to" autocomplete="off" autocorrect="off" autocapitalize="off" name="to" value="<?= $this->filters['to'] ?>">
            <span class="input-group-addon">
                <span class="glyphicon glyphicon-calendar"></span>
            </span>
        </div>
