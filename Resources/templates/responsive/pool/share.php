			...
			<div class="panel panel-default invest-container">
				<div class="panel-body">
					...
					<div class="row">
			  		...
			  		<h3 class="col-md-offset-1 standard-margin-top sm-display-none padding-bottom-6" ><?= $this->text('pool-invest-suggest-projects') ?></h3>

					<!-- Widget code -->
					<div class="row standard-margin-top sm-display-none">
						<div class="col-md-5 col-md-offset-1">
						<?php print_r($this->project_suggested) ?>
							<?= $this->project_suggested[0] ?>
						</div>
						<div class="col-md-5">
							<?php //$this->raw('widget_code_investor') ?>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-6 col-sm-offset-3 margin-2">
								<a href="<?= SITE_URL ?>/discover" class="text-decoration-none" >
									<button type="button" class="btn btn-block btn-success" value=""><?= $this->text('pool-invest-share-discover') ?></button>
					  			</a>
					  	</div>
