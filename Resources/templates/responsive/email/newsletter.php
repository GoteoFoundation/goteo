                ...
                <td class="wrapper" align="center" style="padding: 0; margin: 0; border: none; border-spacing: 0px; border-collapse: collapse;vertical-align: top; mso-table-lspace: 0pt; mso-table-rspace: 0pt; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; max-width: 600px !important;">
                 <!-- Top bar logo -->
                    ...
                    <table class="section header" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="column">
                                <table style="padding: 0; margin: 0; border: none; border-spacing: 0px; border-collapse: collapse;vertical-align: top; display: block; width: 100%;">
...
<<<<<<< HEAD
                                            	<img class="img-header" style="max-width:100%; object-fit: cover; width: 100%;" src="<?= $this->asset('img/newsletter/headerd.png') ?>" alt="Goteo" />
=======
                                            	<img class="img-header" style="max-width:100%; object-fit: cover; width: 100%;" src="<?= $this->asset('img/newsletter/header10.png') ?>" alt="Goteo" />
>>>>>>> new-admin-workshops
                                            </td>
                                        </tr>
                                    </tbody>
