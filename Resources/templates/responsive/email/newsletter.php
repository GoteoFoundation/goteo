...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 620px) {
            ...
            .pd-fundacion-dos {
                padding: 0 50% 40px 40% !important;
            }
            .space-footer{
        ...
        @media only screen and (max-width: 320px) {
            ...
            .pd-fundacion-dos {
                padding: 0 10% 40px 25% !important;
            }
        }
...
<body style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse; vertical-align: top; font-family: Roboto,sans-serif; color: #3a3a3a;">
    <table style=" width: 100%; padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top;">
        <tbody style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top;">
            <tr>
                <td class="wrapper" align="center" style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top; mso-table-lspace: 0; mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; max-width: 600px !important;">
                 <!-- Top bar logo -->
                    <table class="section header" cellpadding="0" cellspacing="0" width="100%" border="0" bgcolor="#19b4b2" style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top;">
                        <tr>
                            <td class="column" valign="top" style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top;">
                                <table style="padding: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top; margin: 0 auto;">
                                    <tbody>
                                        <tr>
                                            <td align="left" style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top;">
                                            	<img width="100%" src="<?= $this->asset('img/newsletter/goteo-white.png') ?>" alt="" style="padding: 15px 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top;" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <table class="section header" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="column">
                                <table style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top; display: block; width: 100%;">
                                    <tbody style="display: block; width: 100%;">
                                        <tr style="display: block; width: 100%;">
                                            <td align="left" style="padding: 0; margin: 0; border: none; border-spacing: 0; border-collapse: collapse;vertical-align: top; display: block; width: 100%;">
                        ...
                        <table align="center">
                            <tbody>
                                <tr>
                                    <td align="left">
                                        <p>
                                            <a style="color: #ffffff; background-color: #19b4b2; display: inline-block; padding: 6px 12px; margin-bottom: 0;font-size: 14px;font-weight: 400; line-height: 1.42857143; text-align: center; white-space: nowrap; cursor: pointer; border: 1px solid transparent; border-radius: 4px; text-decoration: none;" href="https://goteo.org/discover">
