    ...
    <div class="form-group">
        <div class="col-md-10 col-md-offset-1">
            <input type="input" class="form-control" placeholder="<?= $this->text('invest-address-name-field') ?>" name="invest-fullname" id="invest-fullname" value="<?= $this->invest_address['name'] ?>" required>
        </div>
    </div>
