            ...
            <div class="amount-box">
                <div class="row col-sm-10 col-sm-offset-2 margin-2" id="amount-container">
                    <div class="col-sm-1 col-sm-offset-1 no-padding col-xs-1">
                        <label for="amount-<?= $reward->id ?>" class="reward-amount"><?= $this->get_currency('html') ?></label>
                    </div>
                    <div class="no-padding container-input-amount col-sm-4 col-xs-10">
                        <input type="number" class="form-control input-amount" name="amount" value="<?= $this->amount ? $this->amount : amount_format($reward->amount, 0, true) ?>" id="amount-<?= $reward->id ?>" min="<?= amount_format($reward->amount, 0, true) ?>" required>
                    </div>
