...
<li>
    ...
    <h4 class="author"><?php echo $this->text('regular-by')?> <a href="<?php echo $url ?>/user/profile/<?php echo htmlspecialchars($user->id) ?>" target="_blank"><?php echo htmlspecialchars(Text::recorta($user->name,40)) ?></a></h4>
