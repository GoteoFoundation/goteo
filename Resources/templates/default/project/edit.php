...
echo $this->insert(__DIR__ . '/../../responsive/partials/components/widgets/micro.php', ['project' => $project, 'admin' => $project->userCanEdit($this->get_user())]);
$this->replace();
...
?>
    ...
    <div id="sub-header">
        <div class="project-header">
            ...
            <h2><span><?php echo $this->ee($project->name) ?></span></h2>
