...
<div class="dropfiles" data-text-upload="<?= $view->escape($text_upload) ?>" data-limit="<?= $limit ?>" data-auto-process="<?= $auto_process ?>" data-multiple="<?= $multiple ?>" data-url="<?= $view->escape($url) ?>">
