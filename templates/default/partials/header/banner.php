...
if (empty($banner->project)) :
    if (!empty($banner->url)) {
        echo '<a href="'.$banner->url.'" class="expand"></a>';
    }
?>
...
<div class="shb-info clearfix">
    ...
    <small><?php echo $this->text('regular-by') ?> <?php echo $banner->project_user_name ?></small>
    <div class="col-return clearfix">
        <h3><?php echo $this->text('project-rewards-social_reward-title') ?></h3>
...
?>
        ...
        <li class="days"><?php echo $banner->project_days ?> <?php echo $this->text('regular-days') ?></li>
        <?php
endif; ?>
    </ul>
</div>
...
?><div class="shb-img"><img src="<?php echo $banner->image->getLink(700, 156, true) ?>" title="<?php echo htmlspecialchars($banner->title) ?>" alt="<?php echo htmlspecialchars($banner->title) ?>" /></div><?php
endif;
