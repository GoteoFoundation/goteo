...
<?php if ($this->projects): ?>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td><a href="/project/<?= $project->id ?>" target="_blank" title="Preview" style="<?php if (isset($project->called)) echo 'color: blue;' ?>"><?php echo (!empty($project->name)) ? $project->name : 'SIN NOMBRE' ?></a></td>
