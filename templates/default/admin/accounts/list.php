...
<div class="widget board">
    ...
    <form id="filter-form" action="/admin/accounts" method="get">
        ...
        <div style="float:left;margin:5px;" id="date-filter-from">
            ...
            <?= View::get('superform/element/datebox.html.php', array('value'=>$filters['date_from'], 'id'=>'date-filter-from', 'name'=>'date_from', 'js' => true)) ?>
        </div>
        <div style="float:left;margin:5px;" id="date-filter-until">
            <label for="date-filter-until">Fecha hasta</label><br />
            <?= View::get('superform/element/datebox.html.php', array('value'=>$filters['date_until'], 'id'=>'date-filter-until', 'name'=>'date_until', 'js' => true)) ?>
        </div>
