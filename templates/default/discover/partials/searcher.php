        ...
        <div class="filter">
            <label for="category"><?= $this->text('discover-searcher-bycategory-header') ?></label>
                <select id="category" name="category[]" multiple size="10">
                    <option class="all" value="all"<?php if (empty($params['category'])) echo ' selected="selected"'; ?>><?= $this->text('discover-searcher-bycategory-all') ?></option>
        ...
        <div class="filter">
            <label for="location"><?= $this->text('discover-searcher-bylocation-header') ?></label>
                <select id="location" name="location[]" multiple size="10">
                    <option class="all" value="all"<?php if (empty($params['location'])) echo ' selected="selected"'; ?>><?= $this->text('discover-searcher-bylocation-all') ?></option>
        ...
        <div class="filter">
            <label for="reward"><?= $this->text('discover-searcher-byreward-header') ?> </label>
                <select id="reward" name="reward[]" multiple size="10">
                    <option class="all" value="all"<?php if (empty($params['reward'])) echo ' selected="selected"'; ?>><?= $this->text('discover-searcher-byreward-all') ?></option>
