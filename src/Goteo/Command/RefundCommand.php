                ...
                foreach($invests as $invest) {
                    ...
                    if( $update ) {
                        ...
                        if ($response->isSuccessful()) {
                            ...
                            $invest = $this->dispatch(AppEvents::INVEST_RETURNED, new FilterInvestRefundEvent($invest, $method, $response))->getInvest();
                            ...
                            $invest = $this->dispatch(AppEvents::INVEST_RETURN_FAILED, new FilterInvestRefundEvent($invest, $method, $response))->getInvest();
