...
namespace Goteo\Util\Twig\Extension;
...
/**
 * Jalali (Persian) Date extension for Twig templates
 */
class JalaliExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFilter('jalali', [$this, 'jalali']),
            new TwigFilter('jalali_format', [$this, 'jalaliFormat']),
        ];
    }
    ...
    {
        return [
            new TwigFunction('jalali_date', [$this, 'jalali']),
            new TwigFunction('jalali_format', [$this, 'jalaliFormat']),
            new TwigFunction('is_jalali_lang', [$this, 'isJalaliLang']),
        ];
    }
