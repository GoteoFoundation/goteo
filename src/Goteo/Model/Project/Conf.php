...
class Conf extends Model
{
     ...
     * @throws Exception
     */
    public static function get($id): Conf
    {
        try {
    ...
    public function validate(&$errors = array()): bool
    {
        ...
        if (!in_array($this->noinvest, ['0','1'])) return false;
    ...
    {
        return $this->impact_calculator;
    }

    public function activateImpactCalculator()
    {
        $this->impact_calculator = true;
    }

    public function deactivateImpactCalculator()
    {
