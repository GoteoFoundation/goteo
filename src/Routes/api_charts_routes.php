...
$api->add('api-chart-project-referer', new Route(
    ...
    array(
        '_controller' => 'Goteo\Controller\Api\ChartsApiController::originStatsAction',
        'type' => 'project',
        'group' => 'referer'
    )
));
...
$api->add('api-charts-referers', new Route(
    ...
    array(
        '_controller' => 'Goteo\Controller\Api\AdminChartsApiController::originStatsAction',
        'id' => null,
        'type' => 'project',
        'group' => 'referer'
    )
...
$api->add('api-chart-aggregates', new Route(
    ...
    array(
        '_controller' => 'Goteo\Controller\Api\AdminChartsApiController::aggregatesAction',
        'type' => 'invests'
    )
));
...
$api->add('api-chart-totals-invests', new Route(
    ...
    array(
        '_controller' => 'Goteo\Controller\Api\AdminChartsApiController::totalInvestsAction',
        'target' => '',
        'method' => 'global',
        'slot' => ''
    )
...
$api->add('api-chart-totals-projects', new Route(
    ...
    array(
        '_controller' => 'Goteo\Controller\Api\AdminChartsApiController::totalProjectsAction',
        'part' => null
    )
));
...
$api->add('api-chart-matcher-raised', new Route(
    ...
    array(
        '_controller' => 'Goteo\Controller\Api\ChartsApiController::statsMatcherAction',
        'type' => 'raised'
    )
));
...
$api->add('api-chart-matcher-origin-projects', new Route(
    ...
    array(
        '_controller' => 'Goteo\Controller\Api\ChartsApiController::originMatcherStatsAction',
        'type' => 'projects'
    )
));
