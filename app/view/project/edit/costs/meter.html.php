...
?>        
    <div class="meter">
        <dl>            
            ...
            <dd class="minimum" style="width: <?php echo number_format(($minimum / $optimum) * 100) ?>%"><span><strong><?php echo number_format($minimum) ?></strong></span></dd>   
            <dt class="optimum"><span><?php echo Text::get('project-view-metter-optimum'); ?></span></dt>
            <dd class="optimum"><strong><?php echo number_format($optimum) ?></strong></dd>
        </dl>
